...
Let $\opS$ be the \structe{system} illustrated in \prefpp{fig:addnoise_LTI}.
\thmboxt{
  $\estHkp(\omega)$ is the optimal least squares estimate if
...
\begin{enumerate}
  \item 
    \begin{align*}
      ...
      \\
      \\\implies \abs{\estH}^2\Swuu - \estH\cancelto{0}{\Swuv} - \estH^\ast\cancelto{0}{\Swvu} + \Swvv
        &= \abs{\estH}^2\Swxx - \estH\Swxy - \estH^\ast\Swxy^\ast + \Swyy
      \\\implies&
        \boxed{
          \Swuu = \frac{\abs{\estH}^2\Swxx - \estH\Swxy - \estH^\ast\Swxy^\ast + \Swyy}
                       {\kappa+\abs{\estH}^2}
                \eqd\frac{F}{G}}
    \end{align*}
  ...
  \item 
    \begin{align*}
      ...
      \\&= \estH\Swxx\brp{\kappa+\cancelto{0}{\abs{\estH}^2}} - \Swyx\brp{\kappa+\abs{\estH}^2} 
         - \estH\brp{\cancelto{0}{\abs{\estH}^2\Swxx} - \estH\Swxy - \estH^\ast\Swxy^\ast + \Swyy}
      \\&= \kappa\estH\Swxx - \Swyx\brp{\kappa+\abs{\estH}^2} 
         + \brp{ \estH^2\Swxy + \abs{\estH}^2\Swxy^\ast - \estH\Swyy}
      \\&= \kappa\estH\Swxx - \kappa\Swyx - \cancelto{0}{\Swyx\abs{\estH}^2} 
         + \brp{ \estH^2\Swxy + \cancelto{0}{\abs{\estH}^2\Swxy^\ast} - \estH\Swyy}
