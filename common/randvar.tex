...
\corbox{
  \brb{\begin{array}{FlCD}
    (1).&\rvY=\psdev\rvX+\pmean & and \\
    (2).&\psdev\neq0            &
  \end{array}}
  \implies
  \brb{
  \ppy(y) = \mcoml{\frac{1}{\abs{\psdev}} \ppx\brp{\frac{y-\pmean}{\psdev}}}
                  {\ope{Dilation} by $\psdev$ and \ope{Translation} by $\pmean$}
  }}
\end{corollary}
\begin{proof}
  \begin{enumerate}
...
\begin{figure}
  ...
  $\ds\begin{array}{|ccccc|}
    ...
    &&
    &&
    \rvY \sim \pN{\mu_x}{\sigma_y^2} = \pN{1}{\frac{1}{2\pi}}
    \\\hline
  \end{array}$
