    ...
    \item Alternate proof (see \citerpg{haaser1991}{278}{0486665097})
      \begin{align*}
        ...
        \\&\le \norm{\vx-\vx_0} \; \norm{\vy-\vy_0}
             + \norm{\vx-\vx_0} \; \norm{\vy_0}
             + \norm{\vx_0} \; \norm{\vy-\vy_0}
          \\&\hspace{4em}\text{by Cauchy-Swartz ineq. \prefpo{thm:cs}}
        \\&\le \brp{\max\setn{\norm{\vx-\vx_0},\, \norm{\vy-\vy_0}}}^2
          \\&\phantom{{}\le{}}
             + \brp{\norm{\vx_0}+\norm{\vy_0}}\max\setn{\norm{\vx-\vx_0},\,\norm{\vy-\vy_0}}
        \\&=   \max\setn{\norm{\vx-\vx_0},\, \norm{\vy-\vy_0}}
        ...
        \\&\implies \inprod{\vx}{\vy}\to\inprod{\vx_0}{\vy_0}
          \\&\hspace{4em}\text{as } \opair{\vx}{\vy}\to\opair{\vx_0}{\vy_0}
      \end{align*}
  \end{enumerate}
\end{proof}
...
\begin{proof}
\begin{enumerate}
  \item These follow directly from properties of \structe{bilinear functionals}\ifsxref{functionals}{thm:bform_polar}.
