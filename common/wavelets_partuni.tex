...
\exbox{
  ...
  \\\indentx\tbox{\includegraphics{../common/math/graphics/pdfs/h_1_2_2_1_pz.pdf}}
    \indentx\tbox{\includegraphics{../common/math/graphics/pdfs/h_1_2_2_1_phi_h.pdf}}
    \indentx\tbox{\includegraphics{../common/math/graphics/pdfs/h_1_2_2_1_psi_g.pdf}}
  \\
\end{example}
\begin{proof}
\begin{align*}
  ...
  \\&= \sqrt{2}\brs{\frac{ \brp{z+1} \brp{z^2 +        z + \frac{2^2}{4}} }
                         { \brp{2}   \brp{1   + \brp{1}  + \frac{2^2}{4}} } z^4}
