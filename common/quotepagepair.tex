...
\end{large}
\vfill
\hfill\includegraphics*[height=10mm]{../common/graphics/watercraft/ghind_djg_blue.eps}%
...
\footnotetext{\begin{tabular}[t]{ll}% Russell quote
  ...
  image: & \url{http://www-history.mcs.st-andrews.ac.uk/PictDisplay/Russell.html}
  \end{tabular}}%
%\vfill\includegraphics*[height=10mm]{../common/graphics/watercraft/ghind_djg_blue.eps}\hfill\mbox{}%
