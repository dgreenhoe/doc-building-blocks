...
\thmbox{\begin{array}{>{\ds}l        c>{\ds}l                                    C                        D}
  ...
  \\\hline%                         & &                                         &                        &
    \opTrn\brs{\ff(x)+\fg(x)}       &=& \brs{\opTrn\ff(x)} + \brs{\opTrn\fg(x)} &  \forall x       \in\C & (\prope{additive})
  \\\opTrn\brs{\alpha\fg(x)}        &=& \alpha\opTrn\fg(x)                      &  \forall x,\alpha\in\C & (\prope{homogeneous})
\end{array}}
\end{theorem}
