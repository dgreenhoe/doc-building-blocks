...
\corbox{\begin{array}{>{\ds}l                      c>{\ds}l                                               D     r@{\hspace{2pt}}l@{\hspace{2pt}}l                      C                      D}
    \mc{3}{N}{Transform}                                                                                & \mc{4}{|N}{Radius of Convergence}                          & \mc{1}{|N}{Domain}    & \mc{1}{|N}{Property}
  \\\hline
    \opLT\brs{ 0                               }  &=&  0                                                & for & A              &\leq\Real(s)  & \leq B               & \forall x,\alpha\in\C & 
  \\\opLT\brs{ -\fg(x)                         }  &=& -\opLT\brs{\fg(x)}                                & for & A-\Real(\alpha)&\leq\Real(s)  & \leq B-\Real(\alpha) & \forall x,\alpha\in\C & 
  \\\opLT\brs{ \ff(x)-\fg(x)                   }  &=&  \opLT\brs{\fg(x)-\ff(x)}                         & for & \max(A,C)      &\leq\Real(s)  & \leq \min(B,D)       & \forall x,\alpha\in\C & 
  \\\opLT\brs{ \sum_{n=1}^\xN \alpha_n\fg_n(x) }  &=&  \sum_{n=1}^\xN \alpha_n\brs{\opLT\brs{\fg_n(x)}} & for &                &              &                      & \forall x,\alpha\in\C & 
\end{array}}

\corbox{\begin{array}{>{\ds}l                      c  >{\ds}l                                             D     l                                                     C}
    \mc{3}{N}{Transform}                                                                                & \mc{2}{|N}{Radius of Convergence}                         & \mc{1}{|N}{Domain}
  \\\hline
    \opLT\brs{ 0                               }  &=&  0                                                & for & \Real(s)\in\intcc{A              }{B              } & \forall x,\alpha\in\C 
  \\\opLT\brs{ -\fg(x)                         }  &=& -\opLT\brs{\fg(x)}                                & for & \Real(s)\in\intcc{A-\Real(\alpha)}{B-\Real(\alpha)} & \forall x,\alpha\in\C 
  \\\opLT\brs{ \ff(x)-\fg(x)                   }  &=&  \opLT\brs{\fg(x)-\ff(x)}                         & for & \Real(s)\in\intcc{\max(A,C)      }{\min(B,D)      } & \forall x,\alpha\in\C 
  \\\opLT\brs{ \sum_{n=1}^\xN \alpha_n\fg_n(x) }  &=&  \sum_{n=1}^\xN \alpha_n\brs{\opLT\brs{\fg_n(x)}} & for & \Real(s)\in\intcc{               }{               } & \forall x,\alpha\in\C 
\end{array}}
\end{corollary}
\begin{proof}
\begin{enumerate}
  \item By \prefpp{thm:opLT}, the operator $\opLT$ is \prope{additive} and \prope{homogeneous}. \label{item:opLT_linear}
