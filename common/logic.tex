  ...
  \item Proofs for the \fncte{classical implication} $\limpc$:
    \begin{enumerate}
      \item Proof that on an \structe{ortho lattice}, $\limpc$ is an \fncte{implication}: %, proof that $\limpc$ has \prope{strong entailment} and \prope{weak modus ponens}:
        ...
        \end{minipage}%
        \hfill\tbox{\includegraphics{../common/math/graphics/pdfs/lat6_o6_10xy-x.pdf}}%
        %\begin{minipage}{25mm}
...
\exboxp{
  ...
  \\\indentx
  \tbox{\includegraphics{../common/math/graphics/pdfs/logic_L2_tf.pdf}}%
  %$\begin{array}{M}%
  %  \psset{yunit=8mm}%
...
\exboxp{
  ...
  \\\indentx
  \tbox{\includegraphics{../common/math/graphics/pdfs/logic_L3_tnf.pdf}}%
  %$\begin{array}{M}%
  %  \psset{yunit=8mm}%
...
\exboxp{
  ...
  \\\indentx\tbox{\includegraphics{../common/math/graphics/pdfs/logic_L3_tnf.pdf}}%
  %$\begin{array}{M}%
  %  \psset{yunit=8mm}%
  %  \gsize\input{../common/math/graphics/logic_L3_tnf.tex}%
  %\end{array}$
...
\exboxp{
  ...
  In the implication table below, values that differ from the classical $x\limp y\eqd \negat{x}\join y$ are \colorbox{shadedcell}{shaded}.
  \\\indentx\tbox{\includegraphics{../common/math/graphics/pdfs/logic_L3_tnf_fft.pdf}}%
  %$\begin{array}{M}%
  %  \psset{yunit=8mm}%
...
\exboxp{
  ...
  \\\indentx\tbox{\includegraphics{../common/math/graphics/pdfs/logic_L5_tpnmf.pdf}}%
  %$\begin{array}{M}%
  %  \psset{yunit=5mm}%
...
\exboxp{
  ...
  \\\indentx\tbox{\includegraphics{../common/math/graphics/pdfs/logic_M2_tmnf.pdf}}%
  %$\begin{array}{M}%
  %  \psset{unit=8mm}%
...
\exboxp{
  ...
  \\\indentx\tbox{\includegraphics{../common/math/graphics/pdfs/logic_BN4_tbnf.pdf}}%
  %$\begin{array}{M}%
  %  \psset{unit=8mm}%
...
\exbox{
  \begin{array}{m{\tw-49mm}}
    ...
    are \colorbox{shadedcell}{shaded}.
  \end{array}
  \tbox{\includegraphics{../common/math/graphics/pdfs/lat6_o6_negor.pdf}}%
  %\begin{array}{M}
  % \psset{unit=5mm}
...
\exboxp{
  ...
  are \colorbox{shadedcell}{shaded}.
  \\\indentx
  \tbox{\includegraphics{../common/math/graphics/pdfs/logic_O6slash_tpqmnf.pdf}}%
  %$\begin{array}{M}%
  %  \psset{unit=8mm}%
