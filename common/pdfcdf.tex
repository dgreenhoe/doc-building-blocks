...
\propbox{
  ...
  \brb{\begin{array}{rc>{\ds}l}
      \ppx(x)    &=& \lim_{\epsilon\to 0} \frac{1}{\epsilon}\psp\setn{x \le \rvX < x+\epsilon}
    \\\ppxy(x,y) &=& \lim_{\varepsilon\to 0} \frac{1}{\varepsilon}\psp\brb{x \le\rvX < x+\varepsilon \land y \le\rvY < y+\varepsilon}
  \end{array}}
  }
\end{proposition}
\begin{proof}
\begin{align*}
  \ppx(x)
    ...
    && \text{\xref{def:pdf}}
  \\&=    \lim_{\epsilon\to 0} \frac{1}{\epsilon}\psp\set{x\in\R}{x \le \rvX < x+\epsilon}
