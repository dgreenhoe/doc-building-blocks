...
\psset{fillstyle=none}%
  \begin{pspicture}(-1,-2)(5,3)
   ...
   %\psbezier[linecolor=blue,showpoints=true]{->}(0, 1)(2, 3)(2, 3)(4, 1)% 
   %\psbezier[linecolor=blue,showpoints=true]{->}(0, 0)(1,-1)(3,0)(4, 1)%  (2,A)
   %\psbezier[linecolor=blue,showpoints=true]{->}(0, 0)(1.25,-0.7)(3.3,-0.2)(4, 1)%  (2,A)
   %\psbezier[linecolor=blue,showpoints=true]{->}(0, 0)(0.97,0.2425)(3.3,-0.2)(4, 1)%  (2,A)
    \psbezier[linecolor=blue]{->}(0, 0)(1.2127,-0.7276)(3.2724,-0.21268)(4, 1)%  (2,A)
   %\psellipticarc{->}(2,0.5)(2,1)(180)(0)
   %\psbezier[linecolor=blue,showpoints=true]{->}(0, 0)(1.5,-1.5)(1.5,-1.5)(4, 1)%
   %\psbezier[linecolor=blue,showpoints=true]{->}(0, 0)(2.25,-0.5)(2.25,-0.5)(4, 1)%
   %\psbezier[linecolor=blue,showpoints=true]{->}(0, 0)(2.5,-1.5)(2.5,-1.5)(4, 1)%
    \psbezier[linecolor=blue]{->}(0,-1)(1,-2)(3,-2)(4,-1)%
    %\psarc{->}(3,2){2.5}{200}{340}
    %\pscurve[linecolor=red,showpoints=true]{->}(0,1)(2,1.8)(4,1)% (1,A)
    %\pscurve[linecolor=red,showpoints=true]{->}(0,1)(1,1.6)(2,1.8)(3,1.6)(4,1)% (1,A)
    %\pscurve[linecolor=red,showpoints=true]{->}(0,0)(2.25,-0.5)(4,1)
    %\psline(0,0)(6,-6)
    %\psline(4,1)(-2,-5)
    \uput [90]{0}(0, 2){$\setX$}
    \uput [90]{0}(4, 2){$\setY$}
    ...
    %\psline(0,0)(4,1)
    %\psline[showpoints=true](2,0.5)(4,-7.5)
...
\psset{fillstyle=solid}%
  \begin{pspicture}(-1,-2)(9,2.8)
   ...
   %\psbezier[linecolor=blue]{->}(0,-1)(1,-2)(3,-2)(4,-1)%
   %\psbezier[linecolor=blue]{->}(4, 1)(5, 2)(7, 2)(8, 1)% (A,1)
   ...
   %\psbezier[linecolor=green]{->}(4,-1)(5,-2)(7,-2)(8,-1)%
    \uput [90]{0}(0, 2){$\setX$}
    \uput [90]{0}(4, 2){$\setY$}
    \uput [90]{0}(8, 2){$\setX$}
    \uput [90]{0}(2, 2){$\rel$}
...
\begin{tabular}{cc}\scriptsize
  \begin{pspicture}(-2.5,-2.5)(3,2.5)% ellipse
    ...
    \uput[0]{0}(2.5,0){$x$}%
    \uput[0]{0}(0,2.5){$y$}%
    %\psline[linecolor=green](-2.5,0)(2.5,0)% x-axis
    %\psline[linecolor=green](0,-2.5)(0,2.5)% y-axis
    %\uput[0]{0}( 0, 1){$1$}
    %\uput[0]{0}( 0,-1){$-1$}
    %\uput[0]{0}(-2, 0){$-2$}
    %\uput[0]{0}( 2, 0){$2$}
