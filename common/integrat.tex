...
\opb{Riemann integration} would start in the upper left hand corner (\diceA\diceA)
...
\end{align*}
\end{minipage}\\
\opb{Lebesgue integration}, on the other hand, groups like values into sets and 
