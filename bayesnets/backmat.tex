...
\bibliography{../common/bib/analysis,../common/bib/language,../common/bib/algebra,../common/bib/biology,../common/bib/found,../common/bib/order,../common/bib/mathmisc,../common/bib/mathhist,../common/bib/probstat,../common/bib/wavelets,../common/bib/approx,../common/bib/digcom,../common/bib/em,../common/bib/english}
