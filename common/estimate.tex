...
%20190407%\setlength{\unitlength}{0.2mm}
%20190407%\begin{picture}(650,350)(-400,-250)
%20190407%  \thicklines
%20190407%  %\graphpaper[10](0,0)(700,100)
%20190407%  \put(- 50,  50){\framebox(100, 50)[c]{Bayesian}          }
%20190407%  \put(  60,  50){\makebox (200, 50)[l]{pdf known and cost function defined}}
%20190407%  \put(   0,   0){\line    (  0,  1)   { 50}               }
%20190407%  \put(-200,   0){\line    (  1,  0)   {400}               }
%20190407%  \put(-200,- 50){\line    (  0,  1)   { 50}               }
%20190407%  \put( 200,- 50){\line    (  0,  1)   { 50}               }
%20190407%
%20190407%  \put(-190,- 50){\makebox (100, 50)[l]{pdf known}         }
%20190407%  \put( 210,- 50){\makebox (100, 50)[l]{pdf not known}     }
%20190407%  \put(-350,- 50){\line    (  1,  0)   {300}               }
%20190407%  \put(-350,-100){\line    (  0,  1)   { 50}               }
%20190407%  \put(-200,-100){\line    (  0,  1)   { 50}               }
%20190407%  \put(- 50,-100){\line    (  0,  1)   { 50}               }
%20190407%  \put( 200,-100){\line    (  0,  1)   {100}               }
%20190407%
%20190407%  \put(-340,- 90){\makebox (100, 45)[t]{uniform cost}      }
%20190407%  \put(-190,- 90){\makebox (100, 45)[t]{absolute cost}     }
%20190407%  \put(- 40,- 90){\makebox (100, 45)[t]{squared cost}      }
%20190407%  \put(-340,- 90){\makebox (100, 45)[b]{(mode of pdf)}     }
%20190407%  \put(-190,- 90){\makebox (100, 45)[b]{(median of pdf)}   }
%20190407%  \put(- 40,- 90){\makebox (100, 45)[b]{(mean of pdf)}     }
%20190407%
%20190407%  \put(-400,-150){\framebox(100, 50)[c]{MAP}               }
%20190407%  \put(-250,-150){\framebox(100, 50)[c]{---}               }
%20190407%  \put(-100,-150){\framebox(100, 50)[c]{mean square}       }
%20190407%  \put( 150,-150){\framebox(100, 50)[c]{mini-max}          }
%20190407%
%20190407%  \put(-340,-200){\makebox (100, 50)[l]{no prior probability information}}
%20190407%  \put(-350,-200){\line    (  0,  1)   { 50}               }
%20190407%  \put(-400,-250){\framebox(100, 50)[c]{ML}                }
%20190407%
%20190407%  \put( 210,-200){\makebox (100, 50)[l]{no cost function}  }
%20190407%  \put( 200,-200){\line    (  0,  1)   { 50}               }
%20190407%  \put( 150,-250){\framebox(100, 50)[c]{}                  }
%20190407%  \put( 150,-240){\makebox (100, 30)[t]{Neyman-}    }
%20190407%  \put( 150,-240){\makebox (100, 30)[b]{Pearson}    }
%20190407%
%20190407%\end{picture}
\caption{
...
%---------------------------------------
defbox{
  \mse(\est) \eqd \pE\brs{\brp{\hat{\theta}-\theta}^2}
  }
\end{definition}
...
\thmbox{
  \mse(\hat{\theta}) = 
      \mcom{\pE\brs{\brp{\hat{\theta}-\pE\hat{\theta}}^2}}{variance of $\hat{\theta}$}
    + \mcom{\brs{\pE\hat{\theta} - \theta}^2}{bias of $\hat{\theta}$ squared}
  }
\end{theorem}
\begin{proof}
\begin{align*}
...
\thmbox{\begin{array}{rclD}
  \pE\hat{\mean} &=& \mean                   & (\prope{unbiased})
  \\
  \mse(\hat{\mean}) &=& \frac{\sigma^2}{\xN} & (\prope{consistent})
\end{array}}
\end{theorem}
\begin{proof}
\begin{align*}
  \pE\hat{mean}
    &\eqd \pE \frac{1}{\xN}\sum_{n=1}^{n=\xN} \rvx_n
    && \text{by definition of \fncte{arithmetic mean}}
  \\&=  \frac{1}{\xN}\sum_{n=1}^{n=\xN} \pE\rvx_n
  ...
  \\
  \mse(\hat{\mean}) 
    &= \pE\brp{\hat{\mean}-\pE\hat{\mean}}^2
        +\brp{\pE\hat{\mean}-\mean}^2
    && \text{by \prefp{thm:mse}}
  \\&= \pE\brp{\hat{\mean}-\mean}^2
        +\cancelto{0}{\brp{\mean-\mean}^2}
    && \text{by previous result}
  \\&= \pE\brs{\hat{\mean}^2+\mean^2 -2\hat{\mean}\mean}
  \\&= \pE\brs{\hat{\mean}^2}+\mean^2 -2\mean\pE\hat{\mean}
  \\&= \pE\brs{\hat{\mean}^2} - \mean^2
