...
\begin{tabular}{ll}
    title:              & \fntAdventor\itshape{A Book Concerning Digital Communications}
  ...
  \\document url:       & \footnotesize\url{https://github.com/dgreenhoe/pdfs/blob/master/abcdc.pdf}
                      \\& \footnotesize\url{https://www.researchgate.net/project/Signal-Processing-ABCs}
\end{tabular}
\vfill\mbox{}
%---------------------------------------
