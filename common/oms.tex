...
{\footnotesize\begin{tabular}{ccc}
   \includegraphics{../common/math/graphics/pdfs/Zline.pdf}%   \psset{unit=3mm}\input{../common/math/graphics/oms/Zline.tex}%   
  &\includegraphics{../common/math/graphics/pdfs/realline.pdf}%\psset{unit=3mm}\input{../common/math/graphics/oms/realline.tex}%
  &\includegraphics{../common/math/graphics/pdfs/Cplane.pdf}%  \psset{unit=3mm}\input{../common/math/graphics/oms/Cplane.tex}%  
 ...
 \\ linear ordered metric space
  ...
  \\
    %\input{../common/math/graphics/oms/ring6.tex}%
    \includegraphics{../common/math/graphics/pdfs/ring6.pdf}%
   %&\input{../common/math/graphics/oms/discretemetric6.tex}%
   &\includegraphics{../common/math/graphics/pdfs/discretemetric6.pdf}%
   %&\input{../common/math/graphics/oms/oms_l2e3_235.tex}%
  %&\input{../common/math/graphics/oms/oms_wring5shortd.tex}%
...
%  \centering%
%  \psset{unit=5mm}%
%  \input{../common/math/graphics/oms/Zline.tex}%
%\end{minipage}
...
%  \centering%
%  \psset{unit=3mm}%
%  \input{../common/math/graphics/oms/Cplane.tex}%
%\end{minipage}
