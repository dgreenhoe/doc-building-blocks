...
\begin{enumerate}
  ...
  \begin{align*}
    \Zh(z)
       &= \sqrt{2}\brs{\frac{\brp{z+1}\brp{z+2}}{(1+1)(1+2)z^2}}
...
\begin{align*}
  ...
  \\&= \frac{\sqrt{2}}{\frac{129}{64}} \frac{\brs{ z^2 + \frac{129}{128}z + \frac{1}{128}}}{z^2}
  \\&= \frac{\sqrt{2}}{129} \frac{\brs{ 64z^2 + \frac{129}{2}z + \frac{1}{2}}}{z^2}
  \\&= \frac{\sqrt{2}}{258} \frac{\brs{ 128z^2 + 129z + 1}}{z^2}
