...
\begin{pspicture}(-5,-5)(5,1)
  ...
  %--------------------------------------------------------------------------
  \triRnodeput[7.5mm]{0}{-1.75}{ 0}{mpyL0}{$\sfrac{3}{2}$}%
  \triRnodeput[7.5mm]{0}{-1.75}{-2}{mpyL1}{$\sfrac{5}{2}$}\triLnodeput[7.5mm]{0}{1.75}{-2}{mpyR1}{$-5$}%
  \triRnodeput[7.5mm]{0}{-1.75}{-4}{mpyL2}{$\sfrac{7}{2}$}\triLnodeput[7.5mm]{0}{1.75}{-4}{mpyR2}{$-6$}%
    % |     |   |  |  |  |    |____ $+$ in circle
    % |     |   |  |  |  |_________ L=left / R=right
    % |     |   |  |  |____________ node label
    % |     |   |  |_______________ column location
