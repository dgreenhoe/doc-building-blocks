...
\thmbox{
  \brb{\begin{array}{FrclD}
      1. & \abs{\Fh(0)}       &=&    1                               & and
    \\2. & \abs{\Fh(\pi)}     &=&    0                               & and
    \\3. & \abs{\Fh(\omega_c)}&=&    \sfrac{\sqrt{2}}{2}             &    
  \end{array}}
  \quad\implies\quad
  \brb{\begin{array}{FrclD}
      1. & c&=&\ds\frac{-1 + \sin\brp{\omega_c}}{\cos\brp{\omega_c}} & and
    \\2. & b&=&(c+1)/2                                               & and
    \\3. & a&=&b                                                     & and 
    \\4. & \mc{3}{M}{$\Zh(z)$ has a \structe{zero} at $z=-1$}        & and
    \\5. & \mc{3}{M}{$\Zh(z)$ has a \structe{pole} at $z=-c$}        & \prefp{fig:lpf1}
  \end{array}}
  }
\end{theorem}
\begin{proof}
