...
\\\indentx$\begin{array}{>{\qquad}cNM>{\ds}rc>{\ds}l}
 ...
 %\\&\imark&\citerpc{bracewell1965}{46,243}{???. Same as Weisstein?}  %{cited by other reference} % https://books.google.com/books?id=oVFTDwAAQBAJ&pg=PA92&dq=bracewell+%22pentagram+notation%22&hl=en&sa=X&ved=0ahUKEwigptTEq-DeAhXIi60KHd1RCJIQ6AEILjAB#v=onepage&q=bracewell%20%22pentagram%20notation%22&f=false
  \\
