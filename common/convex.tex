...
%---------------------------------------
\begin{definition}[\structd{intervals on ordered sets}]
\footnote{
...
%=======================================
%---------------------------------------
\begin{definition}[\structd{intervals on lattices}]
\footnote{
  \citePp{duthie1942}{2}, %{$a$=\hie{lower extremity}, $b$=\hie{upper extremity}}\\
  \citePpc{ore1935}{425}{\structe{quotient structures}}
  }
...
\footnote{
  ...
  \citerc{clarkson1936}{strictly convex}
  }
\label{def:convexf}
...
\defbox{\begin{array}{FMMrclD}
    (1).&\propd{convex}           & in $\intoo{a}{b}$ if & \ff(x) &\le& \fy(x) & for $x\in\intoo{a}{b}$ \\
    (2).&\propd{concave}          & in $\intoo{a}{b}$ if & \ff(x) &\ge& \fy(x) & for $x\in\intoo{a}{b}$ \\
    (3).&\propd{strictly convex}  & in $\intoo{a}{b}$ if & \ff(x) &<  & \fy(x) & for $x\in\intoo{a}{b}$ \\
    (4).&\propd{strictly concave} & in $\intoo{a}{b}$ if & \ff(x) &>  & \fy(x) & for $x\in\intoo{a}{b}$
  \end{array}}
\end{definition}
