...
\thmbox{\begin{array}{>{\ds}l        c>{\ds}l                                             D     l              @{\hspace{2pt}}l                                             C                       D}
    \mc{3}{H}{Transform}                                                                & \mc{3}{|H}{Radius of Convergence}                                               & \mc{1}{|N}{Domain}    & \mc{1}{|H}{Property}
  \\\hline
...
\corbox{\begin{array}{>{\ds}l                      c  >{\ds}l                                       D     >{\ds}l                                               C}
    \mc{3}{H}{Transform}                                                                          & \mc{2}{|H}{Radius of Convergence}                         & \mc{1}{|N}{Domain}
  \\\hline
...
\corbox{\begin{array}{>{\ds}lc>{\ds}l                                    D     l                            C }
    \mc{3}{H}{Transform}                                               & \mc{2}{|H}{Radius of Convergence}& \mc{1}{|H}{Domain}
  \\\hline%                                                            &                                  &
