...
\thmbox{\begin{array}{>{\ds}lc>{\ds}r Dl@{\hspace{2pt}}l CD}
  ...
  \\\hline%                  & &                                         &     &                             &                 &                       &
    \opLT\brs{\fg(x-\alpha)} &=& e^{-\alpha s}         \opLT\brs{\fg(x)} & for & \Real(s)                    & \in\intcc{A}{B} & \forall x,\alpha\in\C & (\ope{translation})
  \\\opLT\brs{\fg(\alpha x)} &=& \frac{1}{\abs{\alpha}}\opLT\brs{\fg(x)} & for & \Real\brp{\frac{s}{\alpha}} & \in\intcc{A}{B} & \forall x,\alpha\in\C & (\ope{dilation})
\end{array}}
\end{theorem}
\begin{proof}
\begin{align*}
...
\corbox{\begin{array}{>{\ds}l@{\hspace{2pt}}c@{\hspace{2pt}}>{\ds}r                                                        Dl@{\hspace{2pt}}l                  C                    D}
    \mc{3}{H}{Mapping}                                                                                    & \mc{3}{|H}{Region of Convergence} & \mc{1}{|H}{Domain} & \mc{1}{|H}{Property}\\\hline
    \opLT\brs{\cos \brp{\omega_o x} \fg(x)} &=&  \frac{1}{2}\fG(s-i\omega_o) + \frac{1}{2}\fG(s+i\omega_o) & for & \Real(s) & \in\intcc{A}{B}  & \forall x\in\C     & (\ope{cosine modulation})\\[2ex]
    \opLT\brs{\sin \brp{\omega_o x} \fg(x)} &=& -\frac{i}{2}\fG(s-i\omega_o) + \frac{i}{2}\fG(s+i\omega_o) & for & \Real(s) & \in\intcc{A}{B}  & \forall x\in\C     & (\ope{sine modulation})  \\[2ex]
    \opLT\brs{\cosh\brp{\omega_o x} \fg(x)} &=&  \frac{1}{2}\fG(s- \omega_o) + \frac{1}{2}\fG(s+ \omega_o) & for & \Real(s) & \in\intcc{A}{B}  & \forall x\in\C     & (\ope{cosine modulation})\\[2ex]
    \opLT\brs{\sinh\brp{\omega_o x} \fg(x)} &=&  \frac{1}{2}\fG(s- \omega_o) - \frac{1}{2}\fG(s+ \omega_o) & for & \Real(s) & \in\intcc{A}{B}  & \forall x\in\C     & (\ope{cosine modulation})
\end{array}}
\end{corollary}
\begin{proof}
\begin{align*}
  ...
  \\&=\mathrlap{
       \opLT\brs{\brp{\frac{e^{i\omega_o x} + e^{-i\omega_o x}}{2}} \fg(x)}
        \qquad\forall \Real(s)\in\intcc{A-\Real(-i\omega_o)}{B-\Real(i\omega_o)}
        \qquad\text{by \thme{Euler formulas} \xref{cor:eform}}
        }
  \\&=     \frac{1}{2}\opLT\brs{e^{ i\omega_o x} \fg(x)}(s)
         + \frac{1}{2}\opLT\brs{e^{-i\omega_o x} \fg(x)}(s)
        && \forall \Real(s)\in\intcc{A-0}{B-0}
        && \text{by \prope{additive} property}
        && \text{\xref{thm:opLT_linear}}
  \\&=     \frac{1}{2}\opLT\brs{\fg(x)}(s-i\omega)
         + \frac{1}{2}\opLT\brs{\fg(x)}(s+i\omega)
  ...
  \\&=     \frac{1}{2i}\opLT\brs{e^{ i\omega_o x} \fg(x)}(s)
         - \frac{1}{2i}\opLT\brs{e^{-i\omega_o x} \fg(x)}(s)
        && \forall \Real(s)\in\intcc{A-0}{B-0}
        && \text{by \prope{additive} property}
        && \text{\xref{thm:opLT_linear}}
  \\&=     \frac{1}{2i}\opLT\brs{\fg(x)}(s-i\omega)
         - \frac{1}{2i}\opLT\brs{\fg(x)}(s+i\omega)
        && \forall \Real(s)\in\intcc{A}{B}
        && \text{by \prope{modulation} prop.}
        && \text{\xref{thm:opLT_mod}}
  \\&=    -\frac{i}{2}\opLT\brs{\fg(x)}(s-i\omega)
          +\frac{i}{2}\opLT\brs{\fg(x)}(s+i\omega)
        && \forall \Real(s)\in\intcc{A}{B}
  ...
  \\&=\mathrlap{
       \opLT\brs{\brp{\frac{e^{\omega_o x} + e^{-\omega_o x}}{2}} \fg(x)}
        \qquad\forall \Real(s)\in\intcc{A-\Real(-\omega_o)}{B-\Real(\omega_o)}
        \qquad\text{by definition of $\cosh(x)$ \xref{def:cosh}}
        }
  ...
  \\&=\mathrlap{
       \opLT\brs{\brp{\frac{e^{\omega_o x} - e^{-\omega_o x}}{2}} \fg(x)}
        \qquad\forall \Real(s)\in\intcc{A-\Real(-\omega_o)}{B-\Real(\omega_o)}
        \qquad\text{by definition of $\sinh(x)$ \xref{def:sinh}}
        }
  \\&=     \frac{1}{2}\opLT\brs{e^{ \omega_o x} \fg(x)}(s)
         - \frac{1}{2}\opLT\brs{e^{-\omega_o x} \fg(x)}(s)
        && \forall \Real(s)\in\intcc{A-0}{B-0}
