...
\begin{pspicture}(-4.5,-0.5)(6.5,5.5)
  ...
  %---------------------------------
  \uput[45](Dxyz){$\bid$}%
  \uput[45](Dyz){$\symT^\ocop$}%\uput[45](Dyz){$w^\ocop$}%
  \uput[45](Dxz){$\symC^\ocop$}%\uput[45](Dxz){$x^\ocop$}%
  \uput[135](Dxy){$\symG^\ocop$}%\uput[135](Dxy){$y^\ocop$}%   
  \uput[180](Dx){$f^\ocop$}%     
  \uput[180](Dy){$e^\ocop$}%
  \uput[180](Dz){$d^\ocop$}%
  \uput[0](Db){$g$}%
  %%
  \uput[135](Cxyz){$\symX^\ocop$}%\uput[135](Cxyz){$z^\ocop$}%
  \uput[180](Cxy){$j^\ocop$}%   
  \uput[180](Cyz){$h^\ocop$}%
  \uput[180](Cxz){$i^\ocop$}%
  \uput[180](Cx){$a$}%     
  ...
  \uput[-135](Cb){$\symA$}%
  %
  \uput[45](Bxyz){$\symA^\ocop$}%\uput[45](Bxyz){$v^\ocop$}%
  \uput[0](Byz){$a^\ocop$}%
  \uput[0](Bxz){$b^\ocop$}%
  \uput[0](Bxy){$c^\ocop$}%   
  \uput[0](Bx){$h$}%     
