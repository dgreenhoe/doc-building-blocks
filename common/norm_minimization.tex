...
\begin{enumerate}
  ...
  \item lemma:\label{ilem:plant2}
    \begin{align*}
      \boxed{\pderiv{}{A}\esth(t)}
        ...
        && \text{by definition of $\esth(t)$}
      \\&= \frac{\brs{1+\brp{\frac{A}{B}-1}e^{-\alpha t}} - A\brs{\frac{1}{B}-1}e^{-\alpha t}(-t)}
  ...
  \item 
    ...
    \\&= \boxed{\sum_{n=0}^{n=10}\esth^2(t_n)\brs{\esth(t_n)-y_n}t_ne^{-\alpha t_n}}
    \\&\eqd D\fCost(\alpha ) 
  ...
  \item 
    ...
    \\&= \boxed{\sum_{n=0}^{n=10}  \brs{1 - e^{-\alpha t_n} } \esth^2(t_n) \brs{\esth(t_n)-y_n}}
    \end{align*}
\end{enumerate}
