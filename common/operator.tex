...
%\begin{fsL}
%\[\begin{array}{*{5}{>{\ds}c}}
%     && \fcolorbox{red}{bg_red}{\parbox[c]{3\tw/16}{\centering {operator}}} \index{operator}
...
%     && \fcolorbox{blue}{bg_blue}{\parbox[c]{3\tw/16}{\centering {isometric} $\opAa\opA\eqo\opI$}} \index{operator!isometric}
%  \\ \Uparrow & \Nwarrow  & & \Nearrow
%  \\ \fcolorbox{blue}{bg_blue}{\parbox[c]{3\tw/16}{\centering {self-adjoint} $\opA\eqo\opAa$}}  \index{operator!self-adjoint}
%     && \fcolorbox{blue}{bg_blue}{\parbox[c]{3\tw/16}{\centering {invertible} $\opAi$ is an operator}} \index{operator!invertible}
%  \\ && \Uparrow
%  \\ && \fcolorbox{blue}{bg_blue}{\parbox[c]{3\tw/16}{\centering {unitary} $\opU\opUa=\opUa\opU=\opI$}} \index{operator!unitary}
%\end{array}\]
%\end{fsL}
%\caption{
...
%%=======================================
%\section{Operators on Metric linear spaces}
%%=======================================
%An operator on metric linear spaces is \prope{isometric} (next definition) if it is an \structe{isometry} (\prefp{def:isometry}).
%%--------------------------------------
%\begin{definition}
%\label{def:op_isometric}
%%--------------------------------------
%Let $\metlinspaceX$ and $\metlinspaceY$ be \structe{metric linear spaces}.\footnote{%
%  \structe{metric linear space}: \prefp{def:vs_metric}}
%\defbox{\begin{array}{M}
%  An operator $\opM\in\clOxy$ is \hid{isometric} if
%  \\\qquad$\ds\metric{\vx}{\vy}= \metrica{\opM\vx}{\opM\vy} \qquad\scy \forall \vx,\vy\in\setX$.
%}
%\end{definition}
...
%  {Beginning with the third\vyear of studies,
...
%   As he told me once some\vyears later,
...
%\end{theorem}
%\begin{proof}
%Proof not\vyet complete.\attention
%\begin{enumerate}
