...
\end{example}
  \end{tabular}%
  \tbox{\includegraphics{../common/math/graphics/pdfs/lat3_L3_1x0_-0-x-1_prob.pdf}}
}
...
\end{example}
  \end{tabular}%
  \tbox{\includegraphics{../common/math/graphics/pdfs/lat4_m2_boa_prob.pdf}}
  }
...
\end{example}
  \end{tabular}%
  \tbox{\includegraphics{../common/math/graphics/pdfs/lat6_o6_prob_10adbc.pdf}}
  }
...
\end{example}
  \end{tabular}%
  \tbox{\includegraphics{../common/math/graphics/pdfs/lat4_m2_psE_coin.pdf}}
  }
...
%---------------------------------------
  \centering
  \exbox{
    \tbox{\includegraphics{../common/math/graphics/pdfs/lat8_l2e3_prob_coin.pdf}}
...
\tbox{\includegraphics{../common/math/graphics/pdfs/lat4_m2_prob_die.pdf}}
}
\\
\begin{proof}
\begin{align*}
...
%---------------------------------------
  \centering
  \exbox{
    \tbox{\includegraphics{../common/math/graphics/pdfs/lat8_l2e3_prob_die.pdf}}
    \begin{array}{rclrclrcl}
      \psp(\emptyset) &=&0        & \psp(\setO)          &=& 1               \\
      \psp(\setA)     &=&(1-p)^2  & \psp(\setA\setu\setB)&=&(1-p)^2+2p(1-p)  \\
      \psp(\setB)     &=&2p(1-p)  & \psp(\setA\setu\setC)&=& 2p^2-2p+1       \\
