...
\begin{align*}
  ...
  \\&= 2\estH_R\Swxx - \Swxy - \Swxy^\ast + \cancelto{0}{\Swqq}
  \\&= 2\estH_R\Swxx - 2\Re\Swxy
  \\&= 2\estH_R\Swxx - 2\Re\Swyx
  \\&\implies \estH_R = \frac{\Re\Swyx}{\Swxx}
  \\
  0
  ...
  \\&= \pderiv{}{\estH_I}
       \brp{\Swxx\abs{\estH}^2 - \estH\Swxy - \estH^\ast\Swxy^\ast + \Swqq}
  \\&= \pderiv{}{\estH_I}
       \brp{\Swxx\brs{\estH_R^2+\estH_I^2} - (\estH_I+i\estH_I)\Swxy - (\estH_I-i\estH_I)\Swxy^\ast + \Swqq}
  \\&= 2\estH_I\Swxx - i\Swxy + i\Swxy^\ast + \cancelto{0}{\Swqq}
  \\&= 2\estH_I\Swxx - 2i(i\Im\Swxy)
  \\&= 2\estH_I\Swxx + 2i(i\Im\Swyx)
  \\&= 2\estH_I\Swxx - 2\Im\Swyx
  \\&\implies \estH_I = \frac{\Im\Swyx}{\Swxx}
  \\
  \\
  \estH 
    &= \estH_R + i\estH_I
  \\&= \frac{\Re\Swyx}{\Swxx} + \frac{i\Im\Swyx}{\Swxx}
  \\&= \frac{\Re\Swyx + i\Im\Swyx}{\Swxx}
  \\&= \frac{\Swyx}{\Swxx}
\end{align*}
\end{proof}
