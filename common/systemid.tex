...
\begin{enumerate}
  ...
  \item lemma: \label{ilem:Hs_ineq}
    ...
    %  &&\le \brs{\Swxx\sqrt{\brp{p \Swxx - \Swyy}^2 + 4 p \abs{\Swxy }^2}}^2
    %\\&\iff
    %  4 \abs{\Swxy}^4   +4\Swxx\abs{\Swxy}\brp{p \Swxx - \Swyy} +\Swxx^2\brp{p \Swxx - \Swyy}^2 
    %  &&\le \Swxx^2\brp{p \Swxx - \Swyy}^2 + 4p\Swxx^2\abs{\Swxy }^2
    %\\&\iff
    %  4 \abs{\Swxy}^4   +4\Swxx\abs{\Swxy}\brp{p\Swxx-\Swyy} +\cancelto{0}{\Swxx^2\brp{p\Swxx-\Swyy}^2} 
    %  &&\le \cancelto{0}{\Swxx^2\brp{p\Swxx-\Swyy}^2} + 4p\Swxx^2\abs{\Swxy}^2
    %\\&\iff
    %  4 \abs{\Swxy}^4   +4\Swxx\abs{\Swxy}\brp{p \Swxx - \Swyy}  
    %  &&\le 4p\Swxx^2\abs{\Swxy }^2
    %\\&\iff
    %  4 \abs{\Swxy}^4   +4\Swxx\abs{\Swxy}\brp{\cancelto{0}{p \Swxx}-\Swyy}  
    %  &&\le \cancelto{0}{4p\Swxx^2\abs{\Swxy }^2}
    %\\&\iff
    %  \abs{\Swxy}^4   
    %  &&\le \abs{\Swxy}^2\Swxx\Swyy
    %\\&\iff
    %  \abs{\Swxy}^2   
    %  &&\le \Swxx\Swyy
