...
\qboxns{
  ...
  \footnotetext{\citerpg{bak2013}{29}{1475754264}{{\textsection} Systems in Balance Are Not Complex}}
...
\begin{enumerate}
  ...
  \item Let \label{item:estHk_FG}
        $\begin{array}[t]{rclD}
             F &\eqd& \abs{\estH(\omega)}^2\Swxx(\omega) - \estH(\omega)\Swxy(\omega) - \estH^\ast(\omega)\Swxy^\ast(\omega) + \Swyy(\omega) & and
           \\G &\eqd& \kappa(\omega)+\abs{\estH(\omega)}^2
        \end{array}$

  \item lemma $\brp{\pderiv{}{\estH_R}\Swuu}$: \label{ilem:estHk_HR}
    \begin{align*}
      \boxed{0}
        &= \frac{1}{2}G^20 = \frac{1}{2}G^2\pderiv{}{\estH_R}\Swuu
      ...
      \\&= \frac{1}{2}\brs{2\estH_R\Swxx - \Swxy - \Swxy^\ast}G - \frac{1}{2}2\estH_RF
        && \text{by definition of $F$, $G$}
        && \text{\xref{item:estHk_FG}}
      \\&= \boxed{\estH_R\Swxx G - G\Real\Swxy - \estH_RF}
    \end{align*}
  ...
  \item lemma $\brp{\pderiv{}{\estH_I}\Swuu}$: \label{ilem:estHk_HI}
    \begin{align*}
      ...
      \\&= \frac{1}{2}\brs{2\estH_I\Swxx - i\Swxy + i\Swxy^\ast}G - \frac{1}{2}2\estH_IF
        && \text{by definition of $F$, $G$}
        && \text{\xref{item:estHk_FG}}
      \\&= \boxed{\estH_I\Swxx G + G\Imag\Swxy - \estH_IF}
    \end{align*}
    ...
    \begin{align*}
      0
        &= 0 + i0
         = \frac{1}{2}G^20
         + \frac{1}{2}G^20
         = \frac{1}{2}G^2\pderiv{}{\estH_R}\Swuu
         +i\frac{1}{2}G^2\pderiv{}{\estH_I}\Swuu
