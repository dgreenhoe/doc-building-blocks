...
\hspace{5mm}\tbox{\includegraphics{../common/math/graphics/pdfs/lat5_n5_0abp1.pdf}}
...
\end{array}
\qquad
\tbox{\includegraphics[height=12mm]{../common/math/graphics/pdfs/lat5_n5.pdf}}
}
%\thmbox{
  ...
  \item Proof that $\latL$ does not contain $N5$ $\implies$ $\latL$ is modular:
    \begin{enumerate}
      ...
      \item \label{item:lat_mod_iff_N5_def}
        ...
        %\end{minipage}\hfill%
        \tbox{\includegraphics{../common/math/graphics/pdfs/lat5_n5_xyz.pdf}}\hfill%
        \begin{minipage}{\tw-46mm-22mm}
          ...
          \end{align*}
        \end{minipage}%
        \hfill\tbox{\includegraphics{../common/math/graphics/pdfs/lat5_n5_abz.pdf}}%
        %\begin{minipage}{20mm}%
        %  \centering%
        %  \psset{unit=5mm}%
...
\end{example}
\end{minipage}%
\hfill\tbox{\includegraphics{../common/math/graphics/pdfs/lat5_n5_xyz.pdf}}\hfill\mbox{}%
\\
\begin{proof}
\begin{enumerate}
...
\end{example}
\end{minipage}%
\hfill\tbox{\includegraphics{../common/math/graphics/pdfs/lat6_l4inm2_xyab01.pdf}}\hfill\mbox{}\\%
\begin{proof}
\begin{align*}
...
\tbox{\includegraphics{../common/math/graphics/pdfs/lat6_primo_xyza01.pdf}}\hfill%
...
\end{example}
\end{minipage}%
\hfill\tbox{\includegraphics{../common/math/graphics/pdfs/lat6_primo_dual_xyza01.pdf}}\\
\begin{proof}
\begin{align*}
...
\tbox{\includegraphics{../common/math/graphics/pdfs/lat6_o6bslash_xyab01.pdf}}\hfill%
...
\end{example}
\end{minipage}%
\hfill\tbox{\includegraphics{../common/math/graphics/pdfs/lat6_o6_xyab01.pdf}}\\%
\begin{proof}
\begin{enumerate}
...
\tbox{\includegraphics{../common/math/graphics/pdfs/lat7_veeino6_xyzab01.pdf}}\hfill%
...
\hfill\tbox{\includegraphics{../common/math/graphics/pdfs/lat7_wedgeino6_xyabc01.pdf}}\\
\begin{proof}
\begin{align*}
...
\mc{8}{c|}{modular but non-distributive lattices on 7 element sets}
  \\\hline
   \mc{2}{c}{\includegraphics{../common/math/graphics/pdfs/lat7_m5.pdf}}%
  &\includegraphics{../common/math/graphics/pdfs/lat7_m2m3.pdf}%
  &\includegraphics{../common/math/graphics/pdfs/lat7_l2onm4.pdf}%
  &\includegraphics{../common/math/graphics/pdfs/lat7_l3onm3.pdf}%
  &\includegraphics{../common/math/graphics/pdfs/lat7_l2onm3onl2.pdf}%
  \\
  &
  &\includegraphics{../common/math/graphics/pdfs/lat7_m3m2.pdf}%
  &\includegraphics{../common/math/graphics/pdfs/lat7_m4onl2.pdf}%
  &\includegraphics{../common/math/graphics/pdfs/lat7_m3onl3.pdf}%
  \\\hline
\end{tabular}}
\end{example}
