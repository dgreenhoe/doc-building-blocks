...
\footnote{
  ...
  \citerpgc{shin2008}{293}{0470725648}{
    ...
    which differs from \pref{def:H1}, but see \prefp{app:xcordef}
    },
...
\footnote{
  \citerpgc{shin2008}{293}{0470725648}{$H_2(f)=\ffrac{\Swyy(f)}{\Swyx(f)}$ (9.65);
    which differs from \pref{def:H2}, but see \prefp{app:xcordef}
    },
  ...
  \item Development of Wicks and Vold (\citeP{wicks1986}):
    \begin{align*}
      ...
      \\\estH \FU-\FV &= \estH \FX-\FY
        && \text{by \prope{left distributive} prop.} % of \ope{linear operator}s
        && \text{\xref{thm:L_LMN}}
