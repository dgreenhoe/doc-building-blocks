...
\begin{pspicture}(-5,-5)(5,1)
  ...
  %            |_____|   
  %-------------------------------------
  \fnodeput{0}{-3}{-1}{delayL1}{$z^{-1}$}%
  \fnodeput{0}{-3}{-3}{delayL2}{$z^{-1}$}%
    %       |   |  |  |  |    |____ $+$ in circle
  ...
  \triRnodeput[7.5mm]{0}{-1.75}{-2}{mpyL1}{$b_1$}%
  \triRnodeput[7.5mm]{0}{-1.75}{-4}{mpyL2}{$b_2$}%
    % |     |   |  |  |  |    |____ $+$ in circle
    % |     |   |  |  |  |_________ L=left / R=right
    % |     |   |  |  |____________ node label
    % |     |   |  |_______________ column location
  ...
  %          (left side)                   (right side)
  %--------------------------------------------------------------------------
  \cnodeput{0}(-0.5, 0){addL0}{$+$}%
  \cnodeput{0}(-0.5,-2){addL1}{$+$}%
    % |     |   |  |  |  |    |____ $+$ in circle
    % |     |   |  |  |  |_________ L=left / R=right
    % |     |   |  |  |____________ node label
    % |     |   |  |_______________ column location
  ...
  % grayed out
  %-------------------------------------
  {\psset{linestyle=dotted,linecolor=gray}%
  \color{gray}%
  \triLnodeput[7.5mm]{0}{1.75}{-2}{mpyR1}{$0$}%
  \triLnodeput[7.5mm]{0}{1.75}{-4}{mpyR2}{$0$}%
  \cnodeput{0}( 0.5, 0){addR0}{$+$}%
  \cnodeput{0}( 0.5,-2){addR1}{$+$}%
  \nnode{ 3}{ 0}{pR0}%
  \nnode{ 3}{-2}{pR1}%
  \fnodeput{0}{ 3}{-1}{delayR1}{$z^{-1}$}%
  \fnodeput{0}{ 3}{-3}{delayR2}{$z^{-1}$}%
  %
