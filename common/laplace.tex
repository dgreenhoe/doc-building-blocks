...
Let the \structe{radius of convergence} of $\fG(s)$ be $A\leq\Real(s)\leq B$
and the \structe{radius of convergence} of $\fF(s)$ be $C\leq\Real(s)\leq D$.
\corbox{\begin{array}{>{\ds}l        c>{\ds}l                   D     l              @{\hspace{2pt}}l    C                        D}
    \mc{3}{N}{Transform}                                      & \mc{3}{|N}{Radius of Convergence}       & \mc{1}{|N}{Domain}    & \mc{1}{|N}{Property}
  \\\hline
    \opLT\brs{\fg(-x)}  &=& \frac{1}{\abs{\alpha}}\fG\brp{-s} & for & \Real\brp{s} & \in\intcc{-B}{-A}  & \forall x,\alpha\in\C & (\ope{reversal})
\end{array}}
\end{corollary}
\begin{proof}
\begin{align*}
...
%======================================
\section{Convolution properties}
%======================================
%--------------------------------------
\begin{definition}
\label{def:conv}
