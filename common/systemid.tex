...
\end{proposition}
\begin{proof}
Note: There is no complete proof here at this time.
...
\begin{align*}
  ...
  \\&=    \lim_{p\to\infty} 
          \frac{\ds 2\Swyx }
                {\ds  \Swxx -\sfrac{1}{p}\Swyy  +
                 \sqrt{\brs{\Swxx -\sfrac{1}{p}\Swyy }^2 + \sfrac{4}{p}\abs{\Swxy }^2}
                }
  \\&=    \frac{\ds 2\Swyx }
               {\ds  \Swxx  +
                 \sqrt{\brs{\Swxx }^2 }
  ...
  \\&=    \frac{\lim_{p\to0} \ddp}{\lim_{p\to0} \ddp}
          \frac{\ds 2p\Swyx }
                {\ds  p\Swxx -\Swyy  +
                 \sqrt{\brs{p\Swxx -\Swyy }^2 + 4p\abs{\Swxy }^2}
                }
