...
\\\defboxp{$\begin{array}{*{2}{Fl@{\,}r@{\,}@{\,}c@{\,}@{\,}l@{\,}M}}
  1. & \trirel(& \infty      ,&\sfrac{\sigma}{2}  ;\distancen&)&{\scs is the} \reld{\txsigma-inframetric inequality} &  6. & \trirel(& \sfrac{1}{2},&2          ;\distancen &)&{\scs is the} \reld{square mean root inequality}    
