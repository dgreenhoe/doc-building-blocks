...
Brook Taylor showed that for \prope{analytic} functions (functions for which all their derivatives exist),
...
On the other hand, the \ope{Fourier Transform} is a kind of counter-part of the Taylor expansion demonstrated above:\footnote{
        \citePp{robinson1982}{886}
        }
