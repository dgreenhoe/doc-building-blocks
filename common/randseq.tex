...
The definitions for $\Rxy(m)$ and $\Rxx(m)$ involve complex numbers. 
...
two common situations:\footnote{
  \citerpg{marple1987}{?}{9780132141499}
  %\citerpg{marple2019}{?}{9780486780528},
  }
\begin{enume}
  \item The presence of an FFT operator in the signal processing path
