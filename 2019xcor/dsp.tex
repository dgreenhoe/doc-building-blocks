...
%======================================
%20190429%\ifdochasnot{seq}{
%20190429%%--------------------------------------
%20190429%\begin{definition}
%20190429%\label{def:sequence}
%20190429%\label{def:seq}
%20190429%\footnote{
%20190429%  \citerp{bromwich1908}{1},
%20190429%  \citerpgc{thomson2008}{23}{143484367X}{Definition 2.1},
%20190429%  \citerpg{joshi1997}{31}{8122408265}
%20190429%  }
%20190429%\label{def:tuple}
%20190429%%--------------------------------------
%20190429%Let $\clFyx$ be the set of all functions from a set $\setY$ to a set $\setX$.
%20190429%Let $\Z$ be the set of integers.
%20190429%\defbox{\begin{array}{l}
%20190429%  \text{A function $\ff$ in $\clFyx$ is a \hid{sequence} over $\setX$ if $\setY=\Z$.}\\
%20190429%  \text{A sequence may be denoted in the form $\ds\seqxZ{x_n}$ or simply as $\ds\seqn{x_n}$.}\\
%20190429%  %\text{A function $\ff$ in $\clFyx$ is an \hid{n-tuple} over $\setX$ if $\setY=\setn{1,2,\ldots,\xN}$.}\\
%20190429%  %\text{An n-tuple may be denoted in the form $\ds\tuplexn{x_n}$ or simply as $\ds\tuplen{x_n}$.}
%20190429%\end{array}}
...
%20190429%\begin{definition}
%20190429%\footnote{
%20190429%  \citerpgc{kubrusly2011}{347}{0817649972}{Example 5.K}
%20190429%  }
%20190429%\label{def:spllR}
%20190429%\label{def:spllF}
%20190429%%--------------------------------------
%20190429%Let $\fieldF$ be a \structe{field} \xref{def:field}.
%20190429%\defboxt{
%20190429%  The \structd{space of all absolutely square summable sequences} $\spllF$ over $\F$ is defined as
%20190429%  \\\indentx$\ds\spllF\eqd\set{\seqxZ{x_n}}{\sum_{n\in\Z}\abs{x_n}^2 < \infty}$
%20190429%  }
%20190429%\end{definition}
%20190429%
%20190429%The space $\spllR$ is an example of a \structe{separable Hilbert space}. 
%20190429%In fact, $\spllR$ is the \emph{only} separable Hilbert space in the sense that all separable Hilbert spaces
%20190429%are isomorphically equivalent. 
%20190429%For example, $\spllR$ is isomorphic to $\spLLR$, the \structe{space of all absolutely square Lebesgue integrable functions}.
%20190429%%That is, their topological structure is the same.
%20190429%%Differences occur in the nature of operators on the spaces.
...
%20190429%%--------------------------------------
%20190429%Let $\convd$ be the \structe{convolution operator} \xref{def:dsp_conv}.
%20190429%\propbox{
%20190429%  \seqn{x_n}\convd\seqn{y_n} = \seqn{y_n}\convd\seqn{x_n}
%20190429%  \qquad{\scy\forall\seqxZ{x_n},\seqxZ{y_n}\in\spllR}
%20190429%  \qquad\text{($\convd$ is \prope{commutative})}
%20190429%  }
%20190429%\end{proposition}
%20190429%\begin{proof}
%20190429%\begin{align*}
%20190429%  [x\convd y](n)
%20190429%    &\eqd \sum_{m\in\Z} x_m y_{n-m}
%20190429%    &&    \text{by \prefp{def:dsp_conv}}
%20190429%  \\&=    \sum_{k\in\Z} x_{n-k} y(k)
%20190429%    &&    \text{where $k=n-m \iff m=n-k$}
%20190429%  \\&=    \sum_{k\in\Z} x_{n-k} y(k)
%20190429%    &&    \text{by change commutivity of addition}
%20190429%  \\&=    \sum_{m\in\Z} x_{n-m} y_m
%20190429%    &&    \text{by change of variables}
%20190429%  \\&=    \sum_{m\in\Z} y_m x_{n-m} 
%20190429%    &&    \text{by \prop{commutative} property of the field over $\C$}
%20190429%  \\&\eqd \brp{y\convd x}_n
%20190429%    &&    \text{by \prefp{def:dsp_conv}}
%20190429%\end{align*}
%20190429%\end{proof}
