...
\end{minipage}\hfill%
\begin{tabular}{c}\includegraphics{larc/graphics/limrp0Rpq.pdf}\end{tabular}\\
%---------------------------------------
...
\end{array}$\qquad
\begin{tabular}{c}\includegraphics{larc/graphics/limrp0.pdf}\end{tabular}
\end{example}
\begin{proof}
\begin{align*}
...
\begin{enumerate}
  \item Proof that the \prope{triangle inequality} property fails to hold in $\dspaceX$:
        ...
        \\\indentx
        $\begin{array}{c}%
          \includegraphics{larc/graphics/larc_trieq.pdf}%
        \end{array}$%
        \hspace{10mm}%
        $\begin{array}{rclcl}%
  ...
  \item Proof that $\dspaceX$ is \prope{not translation invariant}:\label{item:larc_ti}\footnote{\seessp{lab_larc_distances_R2.xlg}}
        ...
        \\\indentx
        $\begin{array}{c}%
          \includegraphics{larc/graphics/larc_ti.pdf}%
        \end{array}$%
        \hspace{10mm}%
        $\begin{array}{rcl}%
  ...
  \item Proof that $\dspaceX$ is \prope{homogeneous}: 
        \\\indentx
        $\begin{array}{c}%
          \includegraphics{larc/graphics/larc_hmg.pdf}%
        \end{array}$%
        \hspace{10mm}%
        $\begin{array}{M}%
...
One such case is illustrated as follows:\footnote{\seessp{lab_larc_distances_R2.xlg}}
  \\\indentx
  $\begin{array}{c}%
    \includegraphics{larc/graphics/larc_euclid_compare.pdf}%
  \end{array}$%
  \hspace{10mm}%
  $\begin{array}{rclcl}%
...
%  \\\indentx
%  $\begin{array}{c}%
%    \includegraphics{larc/graphics/larc_earc_compare.pdf}%
%  \end{array}$%
%  \hspace{10mm}%
...
\begin{figure}
  \centering%
  \gsize%
  \includegraphics{larc/graphics/larc_metex.pdf}
  \hspace{10mm}
...
\begin{figure}
  ...
  \begin{tabstr}{0.75}\begin{tabular}{cc}
    %\hline
        \includegraphics{larc/graphics/larc_ball(0_0_0).pdf} 
      & \includegraphics{larc/graphics/larc_ball(0_0_-1).pdf} 
      \\centered at $\otriple{0}{0}{0}$
      & centered at $\otriple{0}{0}{-1}$
    \\
        \includegraphics{larc/graphics/larc_ball(0_0_-2).pdf} 
      & \includegraphics{larc/graphics/larc_ball(0_0_-3).pdf} 
      \\centered at $\otriple{0}{0}{-2}$
      & centered at $\otriple{0}{0}{-3}$
    \\
        \includegraphics{larc/graphics/larc_ball(0_0_-5).pdf} 
      & \includegraphics{larc/graphics/larc_ball(0_0_-10).pdf} 
      \\centered at $\otriple{0}{0}{-5}$
      & centered at $\otriple{0}{0}{-10}$
    %\\
    %\includegraphics{larc/graphics/larc_ball(0_0_-2).pdf}%
    %\\ unit Lagrange arc distance ball 
    %\includegraphics{larc/graphics/larc_ball(00_00_05).pdf}%
    %&
    %\includegraphics{larc/graphics/ae_ball(00_00_05).pdf}%
    %\\ unit Lagrange arc distance ball 
