...
\thmbox{\begin{array}{rc>{\ds}l@{\qquad}C}
  \cos(n\fvx) &=&  
     \sum_{k=0}^\floor{\frac{n}{2}}\sum_{m=0}^k      
          (-1)^{k+m}\binom{n}{2k}\binom{k}{m} (\cos\fvx)^{n-2(k-m)}
     & \forall n\in\Znn \text{ and } \fvx\in\R
  \\
  \sin(n\fvx) &=&  
     \sum_{k=0}^\floor{\frac{n}{2}}\sum_{m=0}^k      
          (-1)^{k+m}\binom{n}{2k}\binom{k}{m} (\sin\fvx)^{n-2(k-m)}
     & \forall n\in\Znn \text{ and } \fvx\in\R
  \end{array}}
\end{theorem}
\begin{proof}
\begin{align*}
  ...
  \\&= \Re\left[\sum_{k\in\Z}^n \binom{n}{k}(\cos\fvx)^{n-k} (i\sin\fvx)^k\right]
  \\&= \Re\left[\sum_{k\in\Z}^n i^k \binom{n}{k}\cos^{n-k}\fvx \sin^k\fvx \right]
  \\&= \Re\left[  \sum_{k\in\{0,4,\ldots,n\}} \binom{n}{k} \cos^{n-k}\fvx \sin^k\fvx +
        i\sum_{k\in\{1,5,\ldots,n\}} \binom{n}{k} \cos^{n-k}\fvx \sin^k\fvx  \right.
       \\& \left.
        -\sum_{k\in\{2,6,\ldots,n\}} \binom{n}{k} \cos^{n-k}\fvx \sin^k\fvx +
       -i\sum_{k\in\{3,7,\ldots,n\}} \binom{n}{k} \cos^{n-k}\fvx \sin^k\fvx \right]
  \\&= \sum_{k\in\{0,4,\ldots,n\}} \binom{n}{k} \cos^{n-k}\fvx \sin^k\fvx 
        -\sum_{k\in\{2,6,\ldots,n\}} \binom{n}{k} \cos^{n-k}\fvx \sin^k\fvx 
  \\&=   \sum_{k\in\{0,2,\ldots,n\}} \binom{n}{k}(-1)^{\frac{k  }{2}} \cos^{n-k}\fvx \sin^k\fvx 
  \\&=   \sum_{k=0}^\floor{\frac{n}{2}}     \binom{n}{2k}(-1)^k   \cos^{n-2k  }\fvx \sin^{2k  }\fvx 
  \\&=   \sum_{k=0}^\floor{\frac{n}{2}}     \binom{n}{2k}(-1)^k   \cos^{n-2k  }\fvx (1-\cos^2\fvx)^k 
  \\&=   \left[\sum_{k=0}^\floor{\frac{n}{2}}     \binom{n}{2k}(-1)^k   \cos^{n-2k  }\fvx \right]
         \left[\sum_{m=0}^k \binom{k}{m}(-1)^m\cos^{2m}\fvx \right] 
  \\&=   \sum_{k=0}^\floor{\frac{n}{2}}\sum_{m=0}^k      
         (-1)^{k+m}\binom{n}{2k}\binom{k}{m}   \cos^{n-2(k-m)}\fvx 
  \\
  \\
  \sin(n\fvx)
  ...
  \\&= \sum_{k=0}^\floor{\frac{n}{2}}\sum_{m=0}^k      
       (-1)^{k+m}\binom{n}{2k}\binom{k}{m} \cos^{n-2(k-m)}\left(n\left[\fvx-\frac{\pi}{2n}\right]\right)
  \\&= \sum_{k=0}^\floor{\frac{n}{2}}\sum_{m=0}^k
       (-1)^{k+m}\binom{n}{2k}\binom{k}{m} \cos^{n-2(k-m)}\left(n\fvx-\frac{\pi}{2}\right)
  \\&= \sum_{k=0}^\floor{\frac{n}{2}}\sum_{m=0}^k
       (-1)^{k+m}\binom{n}{2k}\binom{k}{m} \sin^{n-2(k-m)}\left(n\fvx\right)
\end{align*}
\end{proof}
...
\begin{align*}
  ...
  \\&=  \sum_{k=0}^5 \binom{5}{k} [\cos\fvx]^{5-k} [i\sin\fvx]^k
  \\&=  \binom{5}{0} [\cos\fvx]^{5-0} [i\sin\fvx]^0 +
        \binom{5}{1} [\cos\fvx]^{5-1} [i\sin\fvx]^1 +
        \binom{5}{2} [\cos\fvx]^{5-2} [i\sin\fvx]^2 + 
  \\& 
        \binom{5}{3} [\cos\fvx]^{5-3} [i\sin\fvx]^3 +
        \binom{5}{4} [\cos\fvx]^{5-4} [i\sin\fvx]^4 +
        \binom{5}{5} [\cos\fvx]^{5-5} [i\sin\fvx]^5
  \\&=     1 \cos^5\fvx 
...
\begin{align*}
  ...
  \\&=  \sum_{k=0}^2 \sum_{m=0}^k      
          (-1)^{k+m}\binom{n}{2k}\binom{k}{m} (\cos\fvx)^{5-2(k-m)}
  \\&=  (-1)^0\binom{5}{0}\binom{0}{0}\cos^5\fvx +
        (-1)^1\binom{5}{2}\binom{1}{0}\cos^3\fvx +
        (-1)^2\binom{5}{2}\binom{1}{1}\cos^5\fvx + 
  \\& 
        (-1)^2\binom{5}{4}\binom{2}{0}\cos^1\fvx +
        (-1)^3\binom{5}{4}\binom{2}{1}\cos^3\fvx +
        (-1)^4\binom{5}{4}\binom{2}{2}\cos^5\fvx
  \\&=  + ( 1)(1)\cos^5\fvx 
        - (10)(1)\cos^3\fvx 
        + (10)(1)\cos^5\fvx 
        + ( 5)(1)\cos\fvx 
...
\begin{align*}
  \cos2\fvx
    &= \sum_{k=0}^\floor{\frac{2}{2}}\sum_{m=0}^k      
         (-1)^{k+m} \binom{3}{2k}\binom{k}{m}(\cos\fvx)^{2-2(k-m)}
  \\&= (-1)^0 \binom{3}{0}\binom{0}{0}\cos^2\fvx +
       (-1)^1 \binom{3}{2}\binom{1}{0}\cos^0\fvx +
       (-1)^2 \binom{3}{2}\binom{1}{1}\cos^2\fvx
  \\&= + (1)(1)\cos^2\fvx 
       - (1)(1) 
       + (1)(1)\cos^2\fvx
  \\&= 2\cos^2\fvx -1
...
\\
  \cos3\fvx
    &= \sum_{k=0}^\floor{\frac{3}{2}}\sum_{m=0}^k      
         (-1)^{k+m} \binom{3}{2k}\binom{k}{m}(\cos\fvx)^{3-2(k-m)}
  \\&= (-1)^0 \binom{3}{0}\binom{0}{0}\cos^3\fvx +
       (-1)^1 \binom{3}{2}\binom{1}{0}\cos^1\fvx +
       (-1)^2 \binom{3}{2}\binom{1}{1}\cos^3\fvx
  \\&= + \binom{3}{0}\binom{0}{0}\cos^3\fvx 
       - \binom{3}{2}\binom{1}{0}\cos^1\fvx 
       + \binom{3}{2}\binom{1}{1}\cos^3\fvx
  \\&= + (1)(1)\cos^3\fvx 
       - (3)(1)\cos^1\fvx 
       + (3)(1)\cos^3\fvx
...
\\
  \cos4\fvx
    &= \sum_{k=0}^\floor{\frac{4}{2}}\sum_{m=0}^k      
         (-1)^{k+m} \binom{4}{2k}\binom{k}{m}(\cos\fvx)^{4-2(k-m)}
  \\&= \sum_{k=0}^2 \sum_{m=0}^k      
         (-1)^{k+m} \binom{4}{2k}\binom{k}{m}(\cos\fvx)^{4-2(k-m)}
  \\&=  (-1)^{0+0}\binom{4}{2\cdot0}\binom{0}{0}(\cos\fvx)^{4-2(0-0)}
       +(-1)^{1+0}\binom{4}{2\cdot1}\binom{1}{0}(\cos\fvx)^{4-2(1-0)}
  \\&\qquad
       +(-1)^{1+1}\binom{4}{2\cdot1}\binom{1}{1}(\cos\fvx)^{4-2(1-1)}
       +(-1)^{2+0}\binom{4}{2\cdot2}\binom{2}{0}(\cos\fvx)^{4-2(2-0)}
  \\&\qquad
       +(-1)^{2+1}\binom{4}{2\cdot2}\binom{2}{1}(\cos\fvx)^{4-2(2-1)}
       +(-1)^{2+2}\binom{4}{2\cdot2}\binom{2}{2}(\cos\fvx)^{4-2(2-2)}
  \\&=  (1)(1) \cos^4\fvx
       -(6)(1) \cos^2\fvx
       +(6)(1) \cos^4\fvx
       +(1)(1) \cos^0\fvx
...
\\
  \cos6\fvx
    &= \sum_{k=0}^\floor{\frac{6}{2}}\sum_{m=0}^k      
         (-1)^{k+m} \binom{6}{2k}\binom{k}{m}(\cos\fvx)^{6-2(k-m)}
  \\&= (-1)^0 \binom{6}{0}\binom{0}{0}\cos^6\fvx +    % 0,0
       (-1)^1 \binom{6}{2}\binom{1}{0}\cos^4\fvx +    % 1,0
       (-1)^2 \binom{6}{2}\binom{1}{1}\cos^6\fvx +    % 1,1
       (-1)^2 \binom{6}{4}\binom{2}{0}\cos^2\fvx +    % 2,0
   \\&
       (-1)^3 \binom{6}{4}\binom{2}{1}\cos^4\fvx +    % 2,1
       (-1)^4 \binom{6}{4}\binom{2}{2}\cos^6\fvx +    % 2,2
       (-1)^3 \binom{6}{6}\binom{3}{0}\cos^0\fvx +    % 3,0
       (-1)^4 \binom{6}{6}\binom{3}{1}\cos^2\fvx +    % 3,1
   \\&
       (-1)^5 \binom{6}{6}\binom{3}{2}\cos^4\fvx +    % 3,2
       (-1)^6 \binom{6}{6}\binom{3}{3}\cos^6\fvx      % 3,3
  \\&= +( 1)(1)\cos^6\fvx      % 0,0
       -(15)(1)\cos^4\fvx      % 1,0
       +(15)(1)\cos^6\fvx      % 1,1
       +(15)(1)\cos^2\fvx      % 2,0
...
\\
  ...
  \\&= \sum_{k=0}^3 \sum_{m=0}^k      
         (-1)^{k+m}\binom{n}{2k}\binom{k}{m} (\cos\fvx)^{7-2(k-m)}
  \\&= (-1)^0\binom{7}{0}\binom{0}{0}\cos^7\fvx +
       (-1)^1\binom{7}{2}\binom{1}{0}\cos^5\fvx +
       (-1)^2\binom{7}{2}\binom{1}{1}\cos^7\fvx + 
       (-1)^2\binom{7}{4}\binom{2}{0}\cos^3\fvx \\&\quad+ 
       (-1)^3\binom{7}{4}\binom{2}{1}\cos^5\fvx + 
       (-1)^4\binom{7}{4}\binom{2}{2}\cos^7\fvx + 
       (-1)^3\binom{7}{6}\binom{3}{0}\cos^1\fvx +
       (-1)^4\binom{7}{6}\binom{3}{1}\cos^3\fvx \\&\quad+
       (-1)^5\binom{7}{6}\binom{3}{2}\cos^5\fvx +
       (-1)^6\binom{7}{6}\binom{3}{3}\cos^7\fvx
  \\&=   ( 1)(1)\cos^7\fvx 
       - (21)(1)\cos^5\fvx 
       + (21)(1)\cos^7\fvx  
       + (35)(1)\cos^3\fvx \\&\quad 
...
\thmbox{\begin{array}{rc>{\ds}l}
  \cos^n\fvx
    &=&  \frac{1}{2^n} \sum_{k=0}^n \binom{n}{k}\cos[(n-2k)\fvx] 
  \\&=&  \left\{\begin{array}{l@{\qquad}M}\ds
      \frac{1}{2^n}\binom{n}{\frac{n}{2}} +
      \frac{1}{2^{n-1}} \sum_{k=0}^{\frac{n}{2}-1} \binom{n}{k}\cos[(n-2k)\fvx]
      & for  $n$ even
      \\ \ds
      \frac{1}{2^{n-1}} \sum_{k=0}^{\floor{\frac{n}{2}}} \binom{n}{k}\cos[(n-2k)\fvx] 
      & for $n$ odd
    \end{array}\right.
\end{array}
}
...
\begin{align*}
  ...
  \\&=  \Reb{\frac{1}{2^n} \sum_{k=0}^n \binom{n}{k} e^{i(n-k)\fvx}e^{-ik\fvx} }
  \\&=  \Reb{\frac{1}{2^n} \sum_{k=0}^n \binom{n}{k} e^{i(n-2k)\fvx}}
  \\&=  \Reb{\frac{1}{2^n} \sum_{k=0}^n \binom{n}{k} \left(\cos[(n-2k)\fvx]+i\sin[(n-2k)\fvx] \right) }
  \\&=  \Reb{\frac{1}{2^n} \sum_{k=0}^n \binom{n}{k} \cos[(n-2k)\fvx]+
             i\frac{1}{2^n} \sum_{k=0}^n \binom{n}{k} \sin[(n-2k)\fvx]  }
  \\&=  \frac{1}{2^n} \sum_{k=0}^n \binom{n}{k}\cos[(n-2k)\fvx] 
...
\begin{align*}
  \cos^0\fvx
    &= \left.\frac{1}{2^n} \sum_{k=0}^n \binom{n}{k}\cos\left([n-2k]\fvx\right)\right|_{n=0}
  \\&= \frac{1}{2^0} \sum_{k=0}^0 \binom{0}{k}\cos[(0-2k)\fvx] 
  \\&= \binom{0}{0}\cos[(0-2\cdot0)\fvx] 
  \\&= 1
  \\
  \cos^1\fvx
    &= \left.\frac{1}{2^n} \sum_{k=0}^n \binom{n}{k}\cos\left([n-2k]\fvx\right)\right|_{n=1}
  \\&= \frac{1}{2^1} \sum_{k=0}^1 \binom{1}{k}\cos[(1-2k)\fvx] 
  \\&= \frac{1}{2}\left[ \binom{1}{0}\cos[(1-2\cdot0)\fvx] + \binom{1}{1}\cos[(1-2\cdot1)\fvx] \right]
  \\&= \frac{1}{2}\left[ 1\cos\fvx + 1\cos(-\fvx) \right]
  \\&= \frac{1}{2}\left( \cos\fvx + \cos\fvx \right)
  \\&= \cos\fvx
  \\
  \cos^2\fvx
    &= \left.\frac{1}{2^n} \sum_{k=0}^n \binom{n}{k}\cos\left([n-2k]\fvx\right)\right|_{n=2}
  \\&= \frac{1}{2^2} \sum_{k=0}^2 \binom{2}{k}\cos\left([2-2k]\fvx\right)
  \\&= \frac{1}{2^2}\left[ 
         \binom{2}{0}\cos\left([2-2\cdot0]\fvx\right) +
         \binom{2}{1}\cos\left([2-2\cdot1]\fvx\right) +
         \binom{2}{2}\cos\left([2-2\cdot2]\fvx\right) +
       \right]
  \\&= \frac{1}{2^2}\left[ 
  ...
  \\
  \cos^3\fvx
    &= \left.\frac{1}{2^n} \sum_{k=0}^n \binom{n}{k}\cos\left([n-2k]\fvx\right)\right|_{n=3}
  \\&= \frac{1}{2^3} \sum_{k=0}^3 \binom{3}{k}\cos\left([3-2k]\fvx\right)
 %\\&= \frac{1}{2^3} \left[
 %       \binom{3}{0}\cos\left([3-2\cdot0]\fvx\right) +
 %       \binom{3}{1}\cos\left([3-2\cdot1]\fvx\right) +
 %       \binom{3}{2}\cos\left([3-2\cdot2]\fvx\right) +
 %       \binom{3}{3}\cos\left([3-2\cdot3]\fvx\right) 
 %     \right]
  \\&= \frac{1}{2^3} \left[
  ...
  \\
  \cos^4\fvx
    &= \left.\frac{1}{2^n} \sum_{k=0}^n \binom{n}{k}\cos\left([n-2k]\fvx\right)\right|_{n=4}
  \\&= \frac{1}{2^4} \sum_{k=0}^4 \binom{4}{k}\cos\left([4-2k]\fvx\right)
  \\&= \frac{1}{2^4} \left[
  ...
  \\
  \cos^5\fvx
    &= \frac{1}{2^{5-1}} \sum_{k=0}^{\floor{\frac{5}{2}}} \binom{5}{k}\cos[(5-2k)\fvx] 
  \\&= \frac{1}{16} \sum_{k=0}^2 \binom{5}{k}\cos[(5-2k)\fvx] 
  \\&= \frac{1}{16} 
       \left[
         \binom{5}{0}\cos5\fvx + \binom{5}{1}\cos3\fvx + 
         \binom{5}{2}\cos\fvx 
       \right]
  \\&= \frac{1}{16} \left[\cos5\fvx + 5\cos3\fvx + 10\cos\fvx \right]
  \\
  \cos^6\fvx
    &= \frac{1}{2^6}\binom{6}{\frac{6}{2}} +
       \frac{1}{2^{6-1}} \sum_{k=0}^{\frac{6}{2}-1} \binom{6}{k}\cos[(6-2k)\fvx] 
  \\&= \frac{1}{2^6}\binom{6}{3} + 
       \frac{1}{2^5}\sum_{k=0}^{2} \binom{6}{k}\cos[(6-2k)\fvx] 
  \\&= \frac{1}{64}20 + 
       \frac{1}{32}\left[
         \binom{6}{0}\cos6\fvx + \binom{6}{1}\cos4\fvx 
         \binom{6}{2}\cos2\fvx 
         \right]
  \\&= \frac{1}{32}\left[\cos6\fvx + 6\cos4\fvx + 15\cos2\fvx + 10\right]
  \\
  \cos^7\fvx
    &= \frac{1}{2^{7-1}} \sum_{k=0}^{\floor{\frac{7}{2}}} \binom{7}{k}\cos[(7-2k)\fvx] 
  \\&= \frac{1}{64} \sum_{k=0}^2 \binom{7}{k}\cos[(7-2k)\fvx] 
  \\&= \frac{1}{64} 
       \left[
         \binom{7}{0}\cos7\fvx + \binom{7}{1}\cos5\fvx + \binom{7}{2}\cos3\fvx + 
         \binom{7}{3}\cos\fvx 
       \right]
...
\begin{figure}
  \centering
  \begin{tabular}{cc}
    \includegraphics{../common/math/graphics/pdfs/dirichlet1.pdf}&\includegraphics{../common/math/graphics/pdfs/dirichlet5.pdf}\\
    $n=1$&$n=5$\\
    \includegraphics{../common/math/graphics/pdfs/dirichlet10.pdf}&\includegraphics{../common/math/graphics/pdfs/dirichlet10.pdf}\\
    $n=10$&$n=20$
  \end{tabular}
    \caption{
...
\thmbox{\begin{array}{>{\ds}rc>{\ds}l c>{\ds}lC}
  \sum_{n=0}^{\xN-1} \cos\brp{nx} 
    ...
    &=& \frac{\sin\brp{\frac{1}{2}x} + \sin\brp{\brs{\xN-\frac{1}{2}}x} }
             {2\sin\brp{\frac{1}{2}x}}
    & \forall x\in\R
  \\
  \sum_{n=0}^{\xN-1} \sin\brp{nx} 
    &=& \frac{1}{2}\cot\brp{\frac{1}{2}x} - \frac{\cos\brp{\brs{\xN-\frac{1}{2}}x}}
                                                 {2\sin\brp{\frac{1}{2}x}}
    &=& \frac{ \cos\brp{\frac{1}{2}x} - \cos\brp{\brs{\xN-\frac{1}{2}}x} }
             {2\sin\brp{\frac{1}{2}x}}
    & \forall x\in\R
\end{array}}
\end{theorem}
