...
\begin{figure}[th]
  ...
  \caption{Lattice of mathematical spaces\label{fig:vector_spaces_vec}}
\end{figure}%
%======================================
...
that gives the space a \structe{topology}\ifsxref{topology}{def:topology}.
...
a \structe{topology} to a \structe{linear space} giving a \structe{topological linear space}\ifsxref{vstopo}{def:toplinspace},
...
\exbox{\begin{array}{N>{\ds}rc>{\ds}l CD}
