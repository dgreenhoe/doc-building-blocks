...
%---------------------------------------
Let $\fx(t)$ be defined as in \pref{def:cenv}.
\defbox{\begin{array}{>{\ds}lMM}
     \fa(t)\cos\brs{2\pi f_c t + \phi(t)}            & is the \structd{amplitude and phase form})     & of $\fx(t)$
   \\\fp(t)\cos(2\pi f_c t) - \fq(t)\sin(2\pi f_c t) & is the \structd{quadrature form})\footnotemark & of $\fx(t)$
   \\\Reb{\fx_l(t)e^{i2\pi f_c t}}                   & is the \structd{complex envelope form})        & of $\fx(t)$
\end{array}}
\footnotetext{
