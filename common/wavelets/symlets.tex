...
\begin{figure}
  ...
  \exboxt{\begin{tabular}{c|c}
    ...
    \includegraphics{graphics/d4_psi_g.pdf}&\includegraphics{graphics/s4_psi_g.pdf}
  \end{tabular}}
...
\begin{figure}
  ...
  \exboxt{\begin{tabular}{c|c}
    ...
    \\\hline
    \includegraphics{graphics/D12_pz.pdf}&\includegraphics{graphics/S12_pz.pdf}\\
    \includegraphics{graphics/d12_phi_h.pdf}&\includegraphics{graphics/s12_phi_h.pdf}\\
    \includegraphics{graphics/d12_psi_g.pdf}&\includegraphics{graphics/s12_psi_g.pdf}
  \end{tabular}}
...
\begin{figure}
  ...
  \exboxt{\begin{tabular}{c|c}
    ...
    \\\hline
    \includegraphics{graphics/D16_pz.pdf}&\includegraphics{graphics/S16_pz.pdf}\\
    \includegraphics{graphics/d16_phi_h.pdf}&\includegraphics{graphics/s16_phi_h.pdf}\\
    \includegraphics{graphics/d16_psi_g.pdf}&\includegraphics{graphics/s16_psi_g.pdf}
  \end{tabular}}
...
\begin{figure}
  ...
  \exbox{\begin{tabular}{c@{\qquad\qquad}c}
    \includegraphics{graphics/S4_pz.pdf}&\includegraphics{graphics/S5_pz.pdf}\\%
    \includegraphics{graphics/S6_pz.pdf}&\includegraphics{graphics/S7_pz.pdf}%
  \end{tabular}}%
  \caption{%
...
\begin{figure}
  \centering%
  \exbox{\begin{tabular}{c@{\qquad\qquad}c}
      \includegraphics{graphics/S8_pz.pdf}&\includegraphics{graphics/S9_pz.pdf}%
    \\\includegraphics{graphics/S10_pz.pdf}&\includegraphics{graphics/S11_pz.pdf}%
    \\\includegraphics{graphics/S12_pz.pdf}&\includegraphics{graphics/S13_pz.pdf}%
    \\\includegraphics{graphics/S14_pz.pdf}&\includegraphics{graphics/S15_pz.pdf}%
    \\\includegraphics{graphics/S16_pz.pdf}&\includegraphics{graphics/S17_pz.pdf}%
  \end{tabular}}%
  \caption{%
