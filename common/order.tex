...
\begin{dingautolist}{"AC}
  ...
  \item \begin{tabular}{m{\tw-38mm}}%
        ...
        \hfill\begin{tabular}{c}%
          \includegraphics{graphics/lat4_m2_1xy0.pdf}%
        \end{tabular}%
...
%  \end{center}%
%\end{minipage}%
\begin{tabular}{c}\includegraphics{graphics/lat6_m2m2.pdf}\end{tabular}\hfill%
...
\end{example}
\end{minipage}%
\hfill\begin{tabular}{c}\includegraphics{graphics/lat6_o6bslash.pdf}\end{tabular}%

\begin{tabular}{c}\includegraphics{graphics/lat7_m2inm2_alt.pdf}\end{tabular}\hfill%
\begin{minipage}{\tw-50mm}\raggedright
%---------------------------------------
\begin{example}
%---------------------------------------
...
\end{example}
\end{minipage}%
\hfill\begin{tabular}{c}\includegraphics{graphics/lat7_m2inm2.pdf}\end{tabular}
...
The Hasse diagrams to the left and right represent 
\emph{equivalent} ordered sets.\\
\begin{tabular}{c}\includegraphics{graphics/lat5_pentbslash_1xyz0.pdf}\end{tabular}\hfill%
\begin{minipage}{\tw-50mm}\raggedright
...
\end{minipage}%
\hfill\begin{tabular}{c}\includegraphics{graphics/lat5_l2onm2_1xyz0.pdf}\end{tabular}%
\end{example}
...
\hfill\begin{tabular}{c}\includegraphics{graphics/lat8_2e3_setxyz.pdf}\end{tabular}\hfill\mbox{}\\%
%\begin{minipage}[c]{40mm}%
%  \begin{center}%
%  \input{../common/math/graphics/lat2xyz.tex}%
%  \end{center}%
...
\hfill\begin{tabular}{c}\includegraphics{graphics/lat8_2e3_set235.pdf}\end{tabular}\hfill\mbox{}\\%
...
\hfill\begin{tabular}{c}\includegraphics{graphics/lat6_plat_P12345.pdf}\end{tabular}\hfill\mbox{}\\%
...
\begin{minipage}{\tw-20mm}%
  ...
  \end{example}
\end{minipage}%
\hfill\begin{tabular}{c}\includegraphics{graphics/lat4_l4_1234.pdf}\end{tabular}\hfill\mbox{}\\%
...
%\end{fsL}
\includegraphics{graphics/orderingsxyz.pdf}%
...
\hfill%
\tbox{\includegraphics{graphics/m2tol4.pdf}}%
...
\end{minipage}%
\hfill%
\tbox{\includegraphics{graphics/m3ton5.pdf}}%
...
\end{minipage}%
\hfill%
\tbox{\includegraphics{graphics/n5ton5.pdf}}%
...
\begin{center}%
\begin{tabular}{c}%
   \includegraphics{graphics/lat6_n6_0abcp1.pdf}
\\\\
  \includegraphics{graphics/lat5_n5_0acp1.pdf}
\end{tabular}
\end{center}%
\end{minipage}
...
\hfill\tbox{\includegraphics{graphics/lat2xyz_antichains.pdf}}%
...
\end{definition}
\end{minipage}%
\\\hfill\tbox{\includegraphics{graphics/lat1.pdf}}
...
\end{definition}
\end{minipage}%
\\\hfill\tbox{\includegraphics{graphics/lat2_l2.pdf}}
...
\begin{figure}
  ...
  \begin{tabular}{|cNc N c|}
    ...
    % direct sum
    %-------------------------------------
    \tbox{\includegraphics{graphics/oset4_Nref.pdf}}
      &+&\tbox{\includegraphics{graphics/oset3_wedge.pdf}}%
      &=& \tbox{\includegraphics{graphics/oset4_Nref.pdf}}%
          \quad%
          \tbox{\includegraphics{graphics/oset3_wedge.pdf}}%
      \\\hline
    ...
    %-------------------------------------
    \tbox{\includegraphics{graphics/oset4_Nref.pdf}}
      &\oplus&\tbox{\includegraphics{graphics/oset3_wedge.pdf}}%
      &=&\tbox{\includegraphics{graphics/oset7_wedge_oplus_Nref.pdf}}%
      \\\hline
    %-------------------------------------
    % direct product
    %-------------------------------------
    \tbox{\includegraphics{graphics/oset4_Nref.pdf}}
      &\times&\tbox{\includegraphics{graphics/oset3_wedge.pdf}}%
      &=&\tbox{\includegraphics{graphics/oset12_wedge_times_Nref.pdf}}% 
      \\\hline
    %-------------------------------------
    % ordinal product
    %-------------------------------------
    \tbox{\includegraphics{graphics/oset4_Nref.pdf}}
      &\otimes&\tbox{\includegraphics{graphics/oset3_wedge.pdf}}%
      &=&\tbox{\includegraphics{graphics/oset12_wedge_otimes_Nref.pdf}}% 
      \\\hline
  \end{tabular}
...
\end{example}
\end{minipage}%
\hfill\includegraphics{graphics/lat4_l4.pdf}\hfill\mbox{}\\%
...
\hfill\tbox{\includegraphics{graphics/m3m3_antichain_abcpqr.pdf}}%
