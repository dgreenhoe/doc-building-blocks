...
\section{Standard definitions}
  ...
  \input{intro/graph.tex}

\section{Order space concepts}
  \input{intro/order.tex}
  \input{intro/lattice.tex}
  \input{../common/isomorphic.tex}
  \input{../common/argmin.tex}

\section{Metric space concepts}
  \input{../common/sspmetrics.tex}
  \input{../common/isometric.tex}
  \input{../common/oms.tex}
