...
\end{theorem}
\end{minipage}
\hfill\tbox{\includegraphics{graphics/opT_estH_cnoise.pdf}}
\footnotetext{
...
\begin{enumerate}
  ...
  \item lemma: $\fCost\brp{\estH}=\Swxx\abs{\estH}^2 - \estH(\omega)\Swxy - \brs{\estH\Swxy}^\ast + \Swqq$.
    ...
    \begin{align*}
      ...
      \\&= \mathrlap{
           \Swrr(\omega) - \Swwq(\omega) - \Swwq^\ast(\omega) + \Swqq(\omega)
  ...
  \item Proof that $\estH = \ffrac{\Swyx}{\Swxx+\Swuu} \eqd \estHa$:
    \begin{align*}
      \estH(\omega)
