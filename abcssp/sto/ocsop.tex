...
\begin{figure}[h]%
  ...
  $\mcom{\begin{array}{N}{\includegraphics{sto/graphics/ocs_rdie.pdf}}\end{array}}{\structe{real die} \xref{ex:realdie}}$
  \begin{tabular}{c} \Huge$+$                                         \end{tabular}
  %$\mcom{\begin{array}{N}{\input{../common/math/graphics/ocs/ocs_rdie.tex}}\end{array}}{\structe{real die} \xref{ex:realdie}}$
  $\mcom{\begin{array}{N}{\includegraphics{sto/graphics/ocs_rdie.pdf}}\end{array}}{\structe{real die} \xref{ex:realdie}}$
  %\begin{tabular}{c}{\input{../common/math/graphics/ocs/ocs_rdie.tex}} \end{tabular}
  \begin{tabular}{c} \Huge$=$                                         \end{tabular}
  %\begin{tabular}{c}{\input{../common/math/graphics/sto/pairdice.tex}}\end{tabular}
  \begin{tabular}{c}{\includegraphics{sto/graphics/pairdice.pdf}}\end{tabular}
    \begin{tabstr}{0.75}%
    $\begin{array}{|r|*{11}{c}|}%
       \hline
...
\begin{figure}[h]
  \gsize%
  \centering%
  %{\input{../common/math/graphics/sto/pdice_xy.tex}}%
  {\includegraphics{sto/graphics/pdice_xy.pdf}}%
...
\begin{figure}[h]
  ...
  $\mcom{\begin{array}{N}{\includegraphics{sto/graphics/ocs_spinner.pdf}}\end{array}}{\structe{spinner} \xref{ex:spinner}}$
  \begin{tabular}{c} \Huge$+$                                         \end{tabular}
  %$\mcom{\begin{array}{N}{\input{../common/math/graphics/ocs/ocs_spinner.tex}}\end{array}}{\structe{spinner} \xref{ex:spinner}}$
  $\mcom{\begin{array}{N}{\includegraphics{sto/graphics/ocs_spinner.pdf}}\end{array}}{\structe{spinner} \xref{ex:spinner}}$
  %\begin{tabular}{c}{\input{../common/math/graphics/ocs/ocs_rdie.tex}} \end{tabular}
  \begin{tabular}{c} \Huge$=$                                         \end{tabular}
  %\begin{tabular}{c}{\input{../common/math/graphics/oms/pspinner.tex}}\end{tabular}
  \begin{tabular}{c}{\includegraphics{sto/graphics/pspinner.pdf}}\end{tabular}
%  \\
  %\begin{tabular}{cc}
    \begin{tabstr}{0.75}%
    $\begin{array}{|r|*{11}{c}|}%
...
\begin{figure}[h]
  \gsize%
  \centering%
  %{\input{../common/math/graphics/sto/pspinner_xy.tex}}%
  {\includegraphics{sto/graphics/pspinner_xy.pdf}}%
...
\begin{figure}[h]
  ...
  {\includegraphics{sto/graphics/rline_argminmax_11312.pdf}}%
...
\begin{figure}[h]
  \gsize%
  \centering%
  %{\input{../common/math/graphics/sto/spinner_x2x.tex}}%
  {\includegraphics{sto/graphics/spinner_x2x.pdf}}%
...
\begin{figure}[h]
  ...
  \brp{\mcom{\begin{array}{c}{\includegraphics{sto/graphics/ocs_rdie.pdf}}\end{array}}{\structe{real die} \xref{ex:realdie}}}
  ...
  \brp{\mcom{\begin{array}{c}{\includegraphics{sto/graphics/ocs_spinner.pdf}}\end{array}}{\structe{spinner} \xref{ex:spinner}}}
  \qquad\text{\Large$=$}\qquad
  %\brp{\mcom{\begin{array}{c}{\input{../common/math/graphics/ocs/ocs_fdie.tex}}\end{array}}{\structe{fair die} \xref{ex:fairdie}}}
  \brp{\mcom{\begin{array}{c}{\includegraphics{sto/graphics/ocs_fdie.pdf}}\end{array}}{\structe{fair die} \xref{ex:fairdie}}}
  $
...
\begin{figure}[h]
  ...
  \brp{\mcom{\begin{array}{c}{\includegraphics{sto/graphics/ocs_spinner_121141.pdf}}\end{array}}{\structe{spinner}}}
  \text{\Large$=$}
  %\brp{\mcom{\begin{array}{c}{\input{../common/math/graphics/ocs/ocs_wagon_121141.tex}}\end{array}}{\structe{wagon wheel}}}
  \brp{\mcom{\begin{array}{c}{\includegraphics{sto/graphics/ocs_wagon_121141.pdf}}\end{array}}{\structe{wagon wheel}}}
  \text{\Large$.$}
  \quad%
  ...
  \brp{\mcom{\begin{array}{c}{\includegraphics{sto/graphics/ocs_wdie_121141.pdf}}\end{array}}{\structe{weighted die}}}
  \text{\Large$.$}
  $
...
\begin{figure}[h]
  \gsize%
  \centering%
  {\includegraphics{sto/graphics/rline_argminmax_11312a.pdf}}%
  %{\input{../common/math/graphics/sto/rline_argminmax_11312a.tex}}%
