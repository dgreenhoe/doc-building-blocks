...
%20171226%%=======================================
%20171226%\section{Motivation}
%20171226%%=======================================
%20171226%\begin{figure}[ht] \color{figcolor}
%20171226%\begin{center}
%20171226%  \psset{
%20171226%    doubleline=true,
%20171226%    nodesep=2mm,
%20171226%    }
%20171226%  \begin{tabular}{ccc}
%20171226%                                & \rnode{pounityp}{partition of unity} &\\
%20171226%  \rnode{pounityq}{quadrature}  & \parbox[][30mm][]{30mm}{\mbox{}}     & \rnode{pounityz}{zero at $z=-1$}\\
%20171226%                                & \rnode{pounityo}{orthonormality}
%20171226%  \end{tabular} %{thm:pun_zero}
...
%20171226%\end{center}
%20171226%\caption{
%20171226%   Implications of scaling function properties
%20171226%   \label{fig:phi_prop}
%20171226%   }
%20171226%\end{figure}
%20171226%
%20171226%A very common property of scaling functions \xrefP{def:mra} is the \prope{partition of unity} property \xrefP{def:pun}.
%20171226%The partition of unity is a kind of generalization of \prope{orthonormality}\ifsxref{vsinprod}{def:orthog};
%20171226%that is, \emph{all} orthonormal scaling functions form a partition of unity\ifsxref{ortho}{thm:quad=>zero_unity}.
%20171226%But the partition of unity property is not just a consequence of orthonormality, but
%20171226%also a generalization of orthonormality, in that if you remove the
%20171226%orthonormality constraint, the partition of unity is still a
%20171226%reasonable constraint in and of itself.
%20171226%
%20171226%There are two reasons why the partition of unity property is a reasonable
%20171226%constraint on its own:
%20171226%\begin{liste}
%20171226%   \item Without a partition of unity, it is difficult to represent a function as simple as a
%20171226%         constant.\footnote{\citePp{jawerth}{8}}
%20171226%
%20171226%  \item For a multiresolution system $\mrasys$, the partition of unity property is equivalent to
%20171226%        $\sum_{n\in\Z} (-1)^n h_n = 0$ \xrefP{thm:pun_zero}.
%20171226%        As viewed from the perspective of \hi{discrete time signal processing} \xref{app:dsp},
%20171226%        %\footnote{\hie{discrete time signal processing}: see \prefpp{app:dsp}.} 
%20171226%        this implies that the scaling coefficients form a ``\structe{lowpass filter}"; 
%20171226%        lowpass filters provide a kind of ``coarse approximation"
%20171226%        of a function. And that is what the scaling function is ``supposed" to do---to provide a coarse approximation 
%20171226%        at some resolution or ``scale" \xrefP{def:mra}.
%20171226%\end{liste}
