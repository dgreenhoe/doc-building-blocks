...
%  \begin{tabular}{|cc|cc|}
%    \hline
%      \includegraphics{ssp/graphics/2xyfnct1.pdf}
%    & \includegraphics{ssp/graphics/2xyfnct2.pdf}
%    & \includegraphics{ssp/graphics/2xynotfnct1.pdf}
%    & \includegraphics{ssp/graphics/2xynotfnct2.pdf}
...
\begin{figure}[h]
  ...
  \centering%
  \psset{unit=5mm}%
  %\input{../common/math/graphics/ftypes.tex}
  \begin{tabular*}{\tw}{c@{\extracolsep\fill}ccc}
     \includegraphics{ssp/graphics/function_x4y4.pdf}
    &\includegraphics{ssp/graphics/surjective_x4y4.pdf}
    &\includegraphics{ssp/graphics/injective_x4y4.pdf}
    &\includegraphics{ssp/graphics/bijective_x4y4.pdf}
