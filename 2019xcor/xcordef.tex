...
\\\indentx$\begin{array}{FMM}
  \imark & We get eight different results for $\Szxy(z)$ & \xref{prop:RxySzxy}\\
...
\propbox{\begin{array}{FM >{\ds}rc l*{3}{@{\hspace{0pt}}l} c >{\ds}rc l*{2}{@{\hspace{0pt}}l}}
    (1).&Papoulis:        & \Rxy(m) &\eqd& \pE[\rvx     &(m)\rvy^\ast&(0&)] &\implies& \Szxy(z) &=&\FH^\ast&( &\omega)\Swxx\brp{?}
  \\(2).&Kay:             & \Rxy(m) &\eqd& \pE[\rvx^\ast&(0)\rvy     &(m&)] &\implies& \Szxy(z) &=&\FH     &( &\omega)\Swxx\brp{?}
  \\(3).&y-star-m:        & \Rxy(m) &\eqd& \pE[\rvx     &(0)\rvy^\ast&(m&)] &\implies& \Szxy(z) &=&\FH^\ast&(-&\omega)\Swxx\brp{?}
  \\(4).&x-star-m:        & \Rxy(m) &\eqd& \pE[\rvx^\ast&(m)\rvy     &(0&)] &\implies& \Szxy(z) &=&\FH     &(-&\omega)\Swxx\brp{?}
  \\(5).&Bendat:          & \Rxy(m) &\eqd& \pE[\rvx     &(0)\rvy     &(m&)] &\implies& \Szxy(z) &=&\FH     &( &\omega)\Swxx\brp{?}
  \\(6).&alt-Bendat:      & \Rxy(m) &\eqd& \pE[\rvx     &(m)\rvy     &(0&)] &\implies& \Szxy(z) &=&\FH     &(-&\omega)\Swxx\brp{?}
  \\(7).&Bendat-star      & \Rxy(m) &\eqd& \pE[\rvx^\ast&(0)\rvy^\ast&(m&)] &\implies& \Szxy(z) &=&\FH^\ast&(-&\omega)\Swxx\brp{?}
  \\(8).&alt-Bendat-star: & \Rxy(m) &\eqd& \pE[\rvx^\ast&(m)\rvy^\ast&(0&)] &\implies& \Szxy(z) &=&\FH     &(-&\omega)\Swxx\brp{?}
\end{array}}
\end{proposition}
\begin{proof}
\begin{align*}
