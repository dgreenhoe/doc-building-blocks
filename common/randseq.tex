...
\\\rembox{\begin{array}{M >{\ds}rc>{\ds}l c >{\ds}rc>{\ds}l }
    Papoulis:        & \Rxy(m) &\eqd& \pE\brs{\rvx     (m)\rvy^\ast(0)} &\implies& \Swxy(\omega) &=& \Fh^\ast( \omega)\Swxx(\omega)
  \\Kay:             & \Rxy(m) &\eqd& \pE\brs{\rvx^\ast(0)\rvy     (m)} &\implies& \Swxy(\omega) &=& \Fh     ( \omega)\Swxx(\omega)
  \\y-star-m:        & \Rxy(m) &\eqd& \pE\brs{\rvx     (0)\rvy^\ast(m)} &\implies& \Swxy(\omega) &=& \Fh^\ast(-\omega)\Swxx(\omega)
  \\x-star-m:        & \Rxy(m) &\eqd& \pE\brs{\rvx^\ast(m)\rvy     (0)} &\implies& \Swxy(\omega) &=& \Fh     (-\omega)\Swxx(\omega)
  \\Bendat:          & \Rxy(m) &\eqd& \pE\brs{\rvx     (0)\rvy     (m)} &\implies& \Swxy(\omega) &=& \Fh     ( \omega)\Swxx(\omega)
  \\alt-Bendat:      & \Rxy(m) &\eqd& \pE\brs{\rvx     (m)\rvy     (0)} &\implies& \Swxy(\omega) &=& \Fh     (-\omega)\Swxx(\omega)
  \\Bendat-star      & \Rxy(m) &\eqd& \pE\brs{\rvx^\ast(0)\rvy^\ast(m)} &\implies& \Swxy(\omega) &=& \Fh^\ast(-\omega)\Swxx(\omega)
  \\alt-Bendat-star: & \Rxy(m) &\eqd& \pE\brs{\rvx^\ast(m)\rvy^\ast(0)} &\implies& \Swxy(\omega) &=& \Fh     (-\omega)\Swxx(\omega)
\end{array}}.
...
\\\rembox{\begin{array}{M >{\ds}rc>{\ds}l c >{\ds}rc>{\ds}l }
    Papoulis:        & \Rxy(m) &\eqd& \pE\brs{\rvx     (m)\rvy^\ast(0)} &\implies& \Swxy(\omega) &=& \Fh^\ast( \omega)\Swxx(\omega)
  \\Kay:             & \Rxy(m) &\eqd& \pE\brs{\rvx^\ast(0)\rvy     (m)} &\implies& \Swxy(\omega) &=& \Fh     ( \omega)\Swxx(\omega)
  \\y-star-m:        & \Rxy(m) &\eqd& \pE\brs{\rvx     (0)\rvy^\ast(m)} &\implies& \Swxy(\omega) &=& \Fh     ( \omega)\Swxx(\omega)
  \\x-star-m:        & \Rxy(m) &\eqd& \pE\brs{\rvx^\ast(m)\rvy     (0)} &\implies& \Swxy(\omega) &=& \Fh^\ast( \omega)\Swxx(\omega)
  \\Bendat:          & \Rxy(m) &\eqd& \pE\brs{\rvx     (0)\rvy     (m)} &\implies& \Swxy(\omega) &=& \Fh     ( \omega)\Swxx(\omega)
  \\alt-Bendat:      & \Rxy(m) &\eqd& \pE\brs{\rvx     (m)\rvy     (0)} &\implies& \Swxy(\omega) &=& \Fh^\ast( \omega)\Swxx(\omega)
  \\Bendat-star      & \Rxy(m) &\eqd& \pE\brs{\rvx^\ast(0)\rvy^\ast(m)} &\implies& \Swxy(\omega) &=& \Fh     ( \omega) \Swxx(\omega)
  \\alt-Bendat-star: & \Rxy(m) &\eqd& \pE\brs{\rvx^\ast(m)\rvy^\ast(0)} &\implies& \Swxy(\omega) &=& \Fh^\ast( \omega) \Swxx(\omega)
\end{array}}
\end{enumerate}
\end{remark}
\begin{proof}
