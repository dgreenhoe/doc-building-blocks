...
\begin{pspicture}(-5,-2.5)(5,0.5)
  ...
  %            |_____|   
  %-------------------------------------
  \fnodeput{0}{0}{-1}{delayL1}{$z^{-1}$}\fnodeput{0}{ 3}{-1}{delayR1}{$z^{-1}$}%
    %       |  |  |  |  |    |____ $+$ in circle
  ...
  %--------------------------------------------------------------------------
  \triRnodeput[7.5mm]{0}{ 1}{ 0}{mpyL0}{$a$}%
  \triRnodeput[7.5mm]{0}{ 1}{-2}{mpyL1}{$b$}%
  \triLnodeput[7.5mm]{0}{-1}{-2}{mpyR1}{$-c$}%
    % |     |   |  |  |  |  |____ $+$ in circle
    % |     |   |  |  |  |_______ L=left / R=right
    % |     |   |  |  |__________ node label
    % |     |   |  |_____________ column location
    % |     |   |________________ row    location
    % |     |____________________ angle of + in circle
    % |__________________________ circle node put
  %--------------------------------------------------------------------------
  % Adders: circles with $+$ inside
  %          (left side)                   (right side)
  %--------------------------------------------------------------------------
  \cnodeput{0}(-0.5, 0){addL0}{$+$}\cnodeput{0}( 0.5, 0){addR0}{$+$}%%
  \pnode(-0.5, -2){addL1} \pnode( 0.5,  -2){addR1}%  at end of delay chain, nothing to add
    % |     |   |  |  |  |    |____ $+$ in circle
    % |     |   |  |  |  |_________ L=left / R=right
    % |     |   |  |  |____________ node label
    % |     |   |  |_______________ column location
