...
\exbox{
  \begin{array}{|r|r|}%
    n  & \fh_{n}
    \\\hline
      0 & \frac{\sqrt{2}}{3}\cdot1
    \\1 & \frac{\sqrt{2}}{3}\cdot\frac{3}{2}
    \\2 & \frac{\sqrt{2}}{3}\cdot\frac{1}{2}
    \\\text{other} & 0
  \end{array}
  \tbox{\includegraphics{../common/math/graphics/pdfs/h_2_3_1_pz.pdf}}
  \tbox{\includegraphics{../common/math/graphics/pdfs/h_2_3_1_phi_h.pdf}}
  \tbox{\includegraphics{../common/math/graphics/pdfs/h_2_3_1_psi_g.pdf}}
  }%
\end{example}
