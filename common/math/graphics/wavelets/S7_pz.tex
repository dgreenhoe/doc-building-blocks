...
\begin{pspicture}(-1.5,-2)(4.1,2)%
  ...
  \rput[bl](-1.45,-1.9){\rnode[t]{zpL}{$p$}$=7$ zeroes}%
  \ncline[linestyle=dotted,linecolor=zero,nodesepA=1pt]{->}{zpL}{zp}%
  \uput{1mm}[30](-1,0){\color{zero}$\scy7$}%
  %-------------------------------------
  % orthogonality zeroes
  %-------------------------------------
  \Cnode [linecolor=zero,linewidth=1pt](  0.357264924004, -0.065232148057 ){z1}%
  \Cnode [linecolor=zero,linewidth=1pt](  0.357264924004,  0.065232148057 ){z2}%
  \Cnode [linecolor=zero,linewidth=1pt](  2.164508455816, -1.339495705929 ){z3}%
  \Cnode [linecolor=zero,linewidth=1pt](  2.164508455816,  1.339495705929 ){z4}%
  \Cnode [linecolor=zero,linewidth=1pt](  0.261923015014, -0.393184544173 ){z5}%
  \Cnode [linecolor=zero,linewidth=1pt](  0.261923015014,  0.393184544173 ){z6}%
  \Cnode*[linecolor=zero,linewidth=1pt](  2.708738754299, -0.494582131062 ){z7}%
  \Cnode*[linecolor=zero,linewidth=1pt](  2.708738754299,  0.494582131062 ){z8}%
  \Cnode*[linecolor=zero,linewidth=1pt](  0.334062818831, -0.206733177748 ){z9}%
  \Cnode*[linecolor=zero,linewidth=1pt](  0.334062818831,  0.206733177748 ){z10}%
  \Cnode*[linecolor=zero,linewidth=1pt](  1.173502032037, -1.761597244626 ){z11}%
  \Cnode*[linecolor=zero,linewidth=1pt](  1.173502032037,  1.761597244626 ){z12}%
  %-------------------------------------
  % p-1=6 radial lines
  %-------------------------------------
  ...
  \rput[tl](-1.45,1.9){$2$\rnode[br]{polesL}{$p$}$-1=13$ poles}%
  \ncline[linestyle=dotted,linecolor=pole,nodesepA=0pt,nodesepB=5pt]{->}{polesL}{poles}%
  \uput{1mm}[30](0,0){\color{pole}$\scy13$}%
  %%-------------------------------------
...
%  %---------------------------
%  \color{pole}
%  \put(-100,-100){\makebox(0,0)[tr]{13 poles}}             % 2p-1 poles
%  \put(-100,-100){\vector(1,1){91}}
%  \put(   0,    0){\makebox(0,0)[c]{$\times$}}
%  \put(   0,    0){\makebox(0,0)[c]{\hspace{1em}$^{13}$}}
%
%  %Zeros
%  %---------------------------
%  \color{zero}
%  \put(-150, -50){\makebox(0,0)[tr]{p=7 zeros}}           % p zeros
%  \put(-150, -50){\vector( 1, 1){43}}
%  \put(-100,    0){\circle{15}$^{7}$}
%
%  \put(   35.7264924004,   -6.5232148057 ) {\circle {15}} 
%  \put(   35.7264924004,    6.5232148057 ) {\circle {15}} 
%  \put(  216.4508455816, -133.9495705929 ) {\circle {15}} 
%  \put(  216.4508455816,  133.9495705929 ) {\circle {15}} 
%  \put(   26.1923015014,  -39.3184544173 ) {\circle {15}} 
%  \put(   26.1923015014,   39.3184544173 ) {\circle {15}} 
%  \put(  270.8738754299,  -49.4582131062 ) {\circle*{15}} 
%  \put(  270.8738754299,   49.4582131062 ) {\circle*{15}} 
%  \put(   33.4062818831,  -20.6733177748 ) {\circle*{15}} 
%  \put(   33.4062818831,   20.6733177748 ) {\circle*{15}} 
%  \put(  117.3502032037, -176.1597244626 ) {\circle*{15}} 
%  \put(  117.3502032037,  176.1597244626 ) {\circle*{15}} 
%\end{picture}