...
\corbox{\begin{array}{F>{\ds}lc>{\ds}c     D     l                             C }
  ...
  \\\hline
    ...
    \\[2ex](2).&
    \opLT\brs{\sin(\omega_o x)e^{-\alpha x}\step(x)} &=& \frac{\omega_o}{(s+\alpha)^2+\omega_o^2}  & for & \Real(s) > -\Real(\alpha) & x,\omega_o\in\R;\,\alpha\in\C
    \\[2ex](3).&
    \opLT\brs{\cos(\omega_o x)e^{\alpha x}\step(-x)} &=& \frac{-s+\alpha}{(s-\alpha)^2+\omega_o^2}  & for & \Real(s) > -\Real(\alpha) & x,\omega_o\in\R;\,\alpha\in\C
    \\[2ex](4).&
    \opLT\brs{\sin(\omega_o x)e^{\alpha x}\step(-x)} &=& \frac{-\omega_o}{(s-\alpha)^2+\omega_o^2}  & for & \Real(s) > -\Real(\alpha) & x,\omega_o\in\R;\,\alpha\in\C
\end{array}}
\end{corollary}
