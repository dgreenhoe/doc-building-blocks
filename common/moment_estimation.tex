...
%---------------------------------------
\thmbox{
  \meanest_{2,n} = \mcom{\meanest_{2,n-1}}{previous}
                 + \mcom{\brs{\frac{n-1}{n}}}{weight}
...
\begin{align*}
  \cmomest_{2,n}
   ...
   \\&=   \sum_{k=1}^{n} \brp{ \rvx_k - \meanest_{n-1} }^2
     ...
     %
   \\&=   \mcom{\brs{ \sum_{k=1}^{n-1} \brp{ \rvx_k - \meanest_{n-1} }^2 }}{$\cmomest_{2,n-1}$} + \brp{ \rvx_n - \meanest_{n-1} }^2
   ...
   \\&=   \cmomest_{2,n-1}
     ...
     %
   \\&=   \cmomest_{2,n-1} + \brs{\frac{n-1}{n}} \brp{ \rvx_n - \meanest_{n-1} }^2
\end{align*}
% Praise the Lord!!!
\end{proof}
...
\thmbox{
  \meanest_{3,n} =
      \cmomest_{3,n-1}
    - \frac{3}{n}  \brp{ \rvx_n-\meanest_{n-1} } \cmomest_{2,n-1}
...
\begin{align*}
  \cmomest_{3,n} =
     &\eqd \sum_{k=1}^n \brp{ \rvx_k - \meanest_n }^3
   ...
   \\&=                 \mcom{\sum_{k=1}^{n-1} \brp{ \rvx_k - \meanest_{n-1} }^3}{$\cmomest_{3,n-1}$} + \brp{ \rvx_n - \meanest_{n-1} }^3
        - \frac{3}{n}   \brp{ \rvx_n-\meanest_{n-1} }  \brs{\mcom{\sum_{k=1}^{n-1} \brp{ \rvx_k - \meanest_{n-1} }^2}{$\cmomest_{2,n-1}$} + \brp{ \rvx_n - \meanest_{n-1} }^2 }
      \\&\qquad + \frac{3}{n^2} \brp{ \rvx_n-\meanest_{n-1} }^2 \brp{ \rvx_n - \meanest_{n-1} }
        - \frac{1}{n^2} \brp{ \rvx_n-\meanest_{n-1} }^3
   \\&=  \cmomest_{3,n-1} + \brp{ \rvx_n - \meanest_{n-1} }^3
        - \frac{3}{n}   \brp{ \rvx_n-\meanest_{n-1} }   \brs{ \cmomest_{2,n-1} + \brp{ \rvx_n - \meanest_{n-1} }^2 }
   ...
   \\&=  \cmomest_{3,n-1} + \brp{ \rvx_n - \meanest_{n-1} }^3
      ...
      \\&\qquad  + \frac{3}{n^2} \brp{ \rvx_n-\meanest_{n-1} }^2 \brp{ \rvx_n - \meanest_{n-1} }
        - \frac{1}{n^2} \brp{ \rvx_n-\meanest_{n-1} }^3
   \\&=  \cmomest_{3,n-1} + \brs{1 -\frac{3}{n} -\frac{1}{n^2} }\brp{ \rvx_n - \meanest_{n-1} }^3
        - \frac{3}{n}   \brp{ \rvx_n-\meanest_{n-1} } \cmomest_{2,n-1}
        + \frac{3}{n^2} \brp{ \rvx_n-\meanest_{n-1} }^2 \brp{\rvx_n-\meanest_{n-1}}
   \\&=  \cmomest_{3,n-1} + \brs{1 -\frac{3}{n} -\frac{1}{n^2} + \frac{3}{n^2}}\brp{ \rvx_n - \meanest_{n-1} }^3
        - \frac{3}{n}   \brp{ \rvx_n-\meanest_{n-1} } \cmomest_{2,n-1}
   \\&=  \cmomest_{3,n-1}
        - \frac{3}{n}  \brp{ \rvx_n-\meanest_{n-1} } \cmomest_{2,n-1}
        + \brs{\frac{n^2-3n+2}{n^2} }\brp{ \rvx_n - \meanest_{n-1} }^3
...
%---------------------------------------
\thmbox{
 \mcom{\cmomest_{4,n}}{new}
  =   \mcom{\cmomest_{4,n-1}}{previous} + \brp{ \rvx_n - \meanest_{n-1} }^4
        - \frac{4}{n  } \brp{ \rvx_n-\meanest_{n-1} }  \cmomest_{3,n-1}
        + \frac{6}{n^2} \brp{ \rvx_n-\meanest_{n-1} }^2\cmomest_{2,n-1}
        - \frac{4}{n^3} \brp{ \rvx_n-\meanest_{n-1} }^3\brp{ \rvx_k - \meanest_{n-1} }   
...
{\begin{align*}
  \cmomest_{4,n} =
     &\eqd \sum_{k=1}^n \brp{ \rvx_k - \meanest_n }^4
   ...
   \\&=   \mcom{\sum_{k=1}^{n-1} \brp{ \rvx_k - \meanest_{n-1} }^4}{$\cmomest_{4,n-1}$} + \brp{ \rvx_n - \meanest_{n-1} }^4
        - \frac{4}{n  } \brp{ \rvx_n-\meanest_{n-1} }   \sum_{k=1}^n \brp{ \rvx_k - \meanest_{n-1} }^3 
        + \frac{6}{n^2} \brp{ \rvx_n-\meanest_{n-1} }^2 \sum_{k=1}^n \brp{ \rvx_k - \meanest_{n-1} }^2 
           \\&\qquad
        - \frac{4}{n^3}   \brp{ \rvx_n-\meanest_{n-1} }^3\sum_{k=1}^n \brp{ \rvx_k - \meanest_{n-1} }   
        + \frac{1}{n^4} n \brp{ \rvx_n-\meanest_{n-1} }^4
   \\&=   \cmomest_{4,n-1} + \brp{ \rvx_n - \meanest_{n-1} }^4
        - \frac{4}{n  } \brp{ \rvx_n-\meanest_{n-1} }  \cmomest_{3,n-1}
        + \frac{6}{n^2} \brp{ \rvx_n-\meanest_{n-1} }^2\cmomest_{2,n-1}
        - \frac{4}{n^3} \brp{ \rvx_n-\meanest_{n-1} }^3\brp{ \rvx_k - \meanest_{n-1} }   
        + \frac{1}{n^3} \brp{ \rvx_n-\meanest_{n-1} }^4
