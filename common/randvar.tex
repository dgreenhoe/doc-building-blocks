...
\begin{enumerate}
  ...
  \item However, note that Note further that in each partition $\setA_n$, $\ff(x)$ is \prope{invertible} and thus
...
\begin{proof}
  \begin{enumerate}
    \item lemma: \label{ilem:YaXb_ffp}
          $\ff(x)=ax+b$ is a \prope{differentiable function} and $\ffp(x)=a$.
