...
\index{convolution}
%======================================
%redundant: laplace.tex %--------------------------------------
%redundant: laplace.tex \begin{definition}
%redundant: laplace.tex \label{def:conv}
%redundant: laplace.tex \footnote{
%redundant: laplace.tex   \citerpg{bachman1964}{6}{9781483267562},
%redundant: laplace.tex   \citerpgc{bracewell1978}{108}{007007013X}{Convolution theorem}
%redundant: laplace.tex   }
%redundant: laplace.tex %--------------------------------------
%redundant: laplace.tex \defbox{\indxs{\conv}\begin{array}{M}
%redundant: laplace.tex   The \opd{convolution operation} is defined as % $\conv\in\clF{\R^2}{\R}$ is defined as
%redundant: laplace.tex   \\\indentx$\ds
%redundant: laplace.tex     \brs{\ff\conv\fg}(x)
%redundant: laplace.tex     \eqd \ff(x)\conv \fg(x)
%redundant: laplace.tex     \eqd \int_{u\in\R} \ff(u)\fg(x-u) \du
%redundant: laplace.tex     \qquad\scy\forall\ff,\fg\in\spLLRBu
%redundant: laplace.tex   $
%redundant: laplace.tex \end{array}}
%redundant: laplace.tex \end{definition}
