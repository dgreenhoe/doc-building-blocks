...
\lembox{
  \brb{\begin{array}{FrclDD}
    (A). & \cov{\fv(t)}{\fv(u)}      &=        & \sigma^2\delta(t-u) & (\propb{white})    
  \\(B). & \pE\brs{\fv(t)}           &=        & 0                   & (\prope{zero-mean})
  \end{array}}
  \implies
...
\thmbox{
  ...
  \brbl{\begin{array}{FrclD}
     ...
     \\(3). & \mc{3}{l}{\psP\setn{\fdoty_n \land \fdoty_m} = \psP\setn{\fdoty_n}\psP\setn{\fdoty_m} & (\prope{independent})
  \end{array}}
  }
\end{theorem}
\begin{proof}
