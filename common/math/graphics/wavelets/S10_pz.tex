...
\begin{pspicture}(-1.5,-2)(4.1,2)%
  ...
  \rput[bl](-1.45,-1.9){\rnode[t]{zpL}{$p$}$=10$ zeroes}%
  \ncline[linestyle=dotted,linecolor=zero,nodesepA=1pt]{->}{zpL}{zp}%
  \uput{1mm}[30](-1,0){\color{zero}$\scy10$}%
  %-------------------------------------
  % orthogonality zeroes
  %-------------------------------------
  \Cnode [linecolor=zero,linewidth=1pt](  0.373571855697,  0.000000000000 ){z1}%
  \Cnode [linecolor=zero,linewidth=1pt](  0.369033577515, -0.092285338033 ){z2}%
  \Cnode [linecolor=zero,linewidth=1pt](  0.369033577515,  0.092285338033 ){z3}%
  \Cnode [linecolor=zero,linewidth=1pt](  2.182330439329, -1.186482305583 ){z4}%
  \Cnode [linecolor=zero,linewidth=1pt](  2.182330439329,  1.186482305583 ){z5}%
  \Cnode [linecolor=zero,linewidth=1pt](  1.604774102128, -1.560652011779 ){z6}%
  \Cnode [linecolor=zero,linewidth=1pt](  1.604774102128,  1.560652011779 ){z7}%
  \Cnode [linecolor=zero,linewidth=1pt](  0.242377019116, -0.475101075012 ){z8}%
  \Cnode [linecolor=zero,linewidth=1pt](  0.242377019116,  0.475101075012 ){z9}%
  \Cnode*[linecolor=zero,linewidth=1pt](  2.676861184132,  0.000000000000 ){z10}%
  \Cnode*[linecolor=zero,linewidth=1pt](  2.550294030395, -0.637759708111 ){z11}%
  \Cnode*[linecolor=zero,linewidth=1pt](  2.550294030395,  0.637759708111 ){z12}%
  \Cnode*[linecolor=zero,linewidth=1pt](  0.353682669071, -0.192289041605 ){z13}%
  \Cnode*[linecolor=zero,linewidth=1pt](  0.353682669071,  0.192289041605 ){z14}%
  \Cnode*[linecolor=zero,linewidth=1pt](  0.320254448240, -0.311449286391 ){z15}%
  \Cnode*[linecolor=zero,linewidth=1pt](  0.320254448240,  0.311449286391 ){z16}%
  \Cnode*[linecolor=zero,linewidth=1pt](  0.852037194290, -1.670140958219 ){z17}%
  \Cnode*[linecolor=zero,linewidth=1pt](  0.852037194290,  1.670140958219 ){z18}%
  %-------------------------------------
  % p-1=9 radial lines
  %-------------------------------------
  ...
  \rput[tl](-1.45,1.9){$2$\rnode[br]{polesL}{$p$}$-1=19$ poles}%
  \ncline[linestyle=dotted,linecolor=pole,nodesepA=0pt,nodesepB=5pt]{->}{polesL}{poles}%
  \uput{1mm}[30](0,0){\color{pole}$\scy19$}%
  %%-------------------------------------
...
%  %---------------------------
%  \color{pole}
%  \put(-100,-100){\makebox(0,0)[tr]{19 poles}}             % 2p-1 poles
%  \put(-100,-100){\vector(1,1){91}}
%  \put(   0,    0){\makebox(0,0)[c]{$\times$}}
%  \put(   0,    0){\makebox(0,0)[c]{\hspace{1em}$^{19}$}}
%
%  %Zeros
%  %---------------------------
%  \color{zero}
%  \put(-120, -50){\makebox(0,0)[tr]{p=10 zeros}}           % p zeros
%  \put(-150, -50){\vector( 1, 1){43}}
%  \put(-100,    0){\circle{15}$^{10}$}
%
%  \put(   37.3571855697,    0.0000000000 ) {\circle {15}} 
%  \put(   36.9033577515,   -9.2285338033 ) {\circle {15}} 
%  \put(   36.9033577515,    9.2285338033 ) {\circle {15}} 
%  \put(  218.2330439329, -118.6482305583 ) {\circle {15}} 
%  \put(  218.2330439329,  118.6482305583 ) {\circle {15}} 
%  \put(  160.4774102128, -156.0652011779 ) {\circle {15}} 
%  \put(  160.4774102128,  156.0652011779 ) {\circle {15}} 
%  \put(   24.2377019116,  -47.5101075012 ) {\circle {15}} 
%  \put(   24.2377019116,   47.5101075012 ) {\circle {15}} 
%  \put(  267.6861184132,    0.0000000000 ) {\circle*{15}} 
%  \put(  255.0294030395,  -63.7759708111 ) {\circle*{15}} 
%  \put(  255.0294030395,   63.7759708111 ) {\circle*{15}} 
%  \put(   35.3682669071,  -19.2289041605 ) {\circle*{15}} 
%  \put(   35.3682669071,   19.2289041605 ) {\circle*{15}} 
%  \put(   32.0254448240,  -31.1449286391 ) {\circle*{15}} 
%  \put(   32.0254448240,   31.1449286391 ) {\circle*{15}} 
%  \put(   85.2037194290, -167.0140958219 ) {\circle*{15}} 
%  \put(   85.2037194290,  167.0140958219 ) {\circle*{15}} 
%\end{picture}                                   
