...
\begin{align*}
  \cmomest_{2,n}
   ...
   \\&=   \cmomest_{2,n-1}
        ...
        - \frac{2}{n} \brp{ x_n-\meanest_{n-1} } \brs{ n\meanest_n - n\meanest_{n-1} }
     %
   \\&=   \cmomest_{2,n-1}
...
\begin{align*}
  \cmomest_{3,n} =
   ...
   \\&=                 \sum_{k=1}^n \brp{ \rvx_k - \meanest_{n-1} }^3
        ...
        + \frac{3}{n^2} \brp{ \rvx_n-\meanest_{n-1} }^2 \sum_{k=1}^n \brp{ \rvx_k - \meanest_{n-1} }
        - \frac{1}{n^3} n \brp{ \rvx_n-\meanest_{n-1} }^3
   \\&=                 \mcom{\brs{\sum_{k=1}^{n-1} \brp{ \rvx_k - \meanest_{n-1} }^3}}{$\cmomest_{3,n-1}$} + \brp{ \rvx_n - \meanest_{n-1} }^3
        - \frac{3}{n}   \brp{ \rvx_n-\meanest_{n-1} }  \brs{\mcom{\sum_{k=1}^{n-1} \brp{ \rvx_k - \meanest_{n-1} }^2}{$\cmomest_{2,n-1}$} + \brp{ \rvx_n - \meanest_{n-1} }^2 }
      \\&\qquad + \frac{3}{n^2} \brp{ \rvx_n-\meanest_{n-1} }^2 \brs{n\mcom{\frac{1}{n}\sum_{k=1}^n \rvx_k}{$\meanest_n$} - \sum_{k=1}^n \meanest_{n-1} }
   ...
   \\&=  \cmomest_{3,n-1} + \brp{ \rvx_n - \meanest_{n-1} }^3
        ...
        + \frac{3}{n^2} \brp{ \rvx_n-\meanest_{n-1} }^2 \brs{n\meanest_n - n \meanest_{n-1} }
      \\&\qquad- \frac{1}{n^2} \brp{ \rvx_n-\meanest_{n-1} }^3
   \\&=  \cmomest_{3,n-1} + \brp{ \rvx_n - \meanest_{n-1} }^3
        - \frac{3}{n}   \brp{ \rvx_n-\meanest_{n-1} } \cmomest_{2,n-1}
        - \frac{3}{n}   \brp{ \rvx_n - \meanest_{n-1} }^3
      \\&\qquad  + \frac{3}{n^2} \brp{ \rvx_n-\meanest_{n-1} }^2 \brs{n\meanest_{n-1}+n\frac{1}{n}\brp{\rvx_n-\meanest_{n-1}} - n \meanest_{n-1} }
        - \frac{1}{n^2} \brp{ \rvx_n-\meanest_{n-1} }^3
