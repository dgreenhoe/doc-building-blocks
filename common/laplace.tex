...
\corbox{\begin{array}{F>{\ds}lc>{\ds}l                                    D     l                                                    C }
    &\mc{3}{N}{Transform}                                               & \mc{2}{|N}{Radius of Convergence}                        & \mc{1}{|N}{Domain}
  \\\hline
    (1).& \opLT\brs{e^{-\alpha\abs{x}}}  &=& \frac{2\alpha}{\alpha^2 - s^2}  & for & \Real(s) \in \intoo{-\Real(\alpha)}{\Real(\alpha)} & x,\alpha\in\R
  \\(2).& \opLT\brs{\cos(\omega_o x)e^{-\alpha\abs{x}}\step( x)}  &=& \frac{ s+\alpha}{(s+\alpha)^2 + \omega_o^2}  & for & \Real(s) \in \intoo{-\Real(\alpha)}{\Real(\alpha)} & x,\alpha\in\R
  \\(3).& \opLT\brs{\cos(\omega_o x)e^{-\alpha\abs{x}}\step(-x)}  &=& \frac{-s+\alpha}{(s-\alpha)^2 + \omega_o^2}  & for & \Real(s) \in \intoo{-\Real(\alpha)}{\Real(\alpha)} & x,\alpha\in\R
  \\(4).& \opLT\brs{\cos(\omega_o x)e^{-\alpha\abs{x}}         }  &=& \frac{ s+\alpha}{(s+\alpha)^2 + \omega_o^2} +  \frac{-s+\alpha}{(s-\alpha)^2 + \omega_o^2}  & for & \Real(s) \in \intoo{-\Real(\alpha)}{\Real(\alpha)} & x,\alpha\in\R
\end{array}}
\end{corollary}
\begin{proof}
\begin{align*}
...
%       \end{array}$
  ...
  \item Alternate proof (more direct):
    \begin{align*}
