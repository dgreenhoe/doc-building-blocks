...
\footnote{
  ...
  \citerpgc{kay1988}{52}{8131733564}{``$r_{xy}[k] = \mfrakE\brb{x^\ast[n]y[n+k]}\quad(3.42)"$},
...
Note that the \ope{expectation} operator $\pE\brp{\rvX\rvY}$ is an \fncte{inner product}.
...
\item If you follow Bendat (or assume $\rvX(n)$ and $\rvY(n)$ are \prope{real-valued}, then\ldots
  \begin{align*}
    \Swxy(\omega)
      &\eqd \opDTFT\pE\Rxy(m)
