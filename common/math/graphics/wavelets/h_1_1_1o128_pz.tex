...
\begin{pspicture}(-2.5,-1.75)(3.5,1.75)%
  ...
  \uput{2pt}[155](0,1.5){\color{axis}$\scy\Imb{z}$}%
  %-------------------------------------
  % unit circle
  %-------------------------------------
  \pscircle[linecolor=unitcircle](origin){1}%
  \rput[bl](-1.5,-1.5){\rnode[t]{circleL}{$\scy\abs{z}=1$}}%
  ...
  % zero at z = z2
  %-------------------------------------
  \pnode(-0.0078125,0){z2}%
  \Cnode[linewidth=1pt](z2){z2node}%
  \rput[bl](-2.5,-1.1){\rnode[r]{z2label}{$\scy{z=-\frac{1}{128}}$}}%
 ...
 %\ncline[linestyle=dashed]{origin}{z2}%
  ...
  \rput[b](-1,1){\rnode[b]{polesL}{\scs$2$ poles at $z=0$}}%
  \ncline[linestyle=dotted,linecolor=pole,nodesepA=0pt,nodesepB=5pt]{->}{polesL}{poles}%
  \uput{1mm}[30](poles){\color{pole}$\scy2$}%
\end{pspicture}%
