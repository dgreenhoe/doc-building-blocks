...
\label{ex:dna_sars}
%---------------------------------------
Consider the genome sequence (DNA sequence) for the SARS coronavirus with \hie{GenBank} accession number NC\_004718.3.\citetbl{\citer{ncbiSars}} %identifier gi30271926.
...
\label{ex:dna_ebola}
%---------------------------------------
Consider the genome sequence (DNA sequence) for the Ebola virus with GenBank accession \lstinline{AF086833.2}.\citetbl{\citer{ncbiEbola}}
...
with GenBank accession \lstinline{NZ_CM003360.1}.\citetbl{\citer{ncbiMP}}
