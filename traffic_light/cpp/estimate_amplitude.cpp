...
//!
//! \see
//! \cite<Deligiannidis2014> 
//!       Leonidas Deligiannidis and Hamid R Arabnia (editors). (2014)
...
//!   
//! \cite<Chaulya2016>
//!       Swadesh Chaulya and G. M. Prasad. (2016)
...
double estimate_amplitude( //! \return estimated amplitude
  ...
  {
    double sum  = std::inner_product( y.begin(), y.end(), y.begin(), 0.0 );
    const long   N    = y.size();
