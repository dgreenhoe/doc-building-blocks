...
#---------------------------------------
 ...
 set size square
 set palette color
 set palette defined (0 "#101010", 0.40 "#0000ff", 0.7 "#00ff00", 0.8 "#e0e000", 1.4 "#ff0000")
...
#---------------------------------------
 a=0.5
 R(u,v) = r+a*rand(0)*rand(0)
 x(u,v) = R(u,v)*(cos(u)*cos(v))**k         # x component of sphere
 y(u,v) = R(u,v)*(cos(u)*sin(v))**k         # y component of sphere
 z(u)   = R(u,u)*(sin(u))**k                # z component of sphere
