...
\exbox{\begin{tabular}{cc|ccc}%
  ...
  \\\hline%
   ...
   \includegraphics{graphics/lat5_m3_ss_xyz.pdf}%
...
\end{minipage}%
\hfill\tbox{\includegraphics{graphics/lattopxy.pdf}}\hfill\mbox{}\\%
\end{example}
...
%  }%
\tbox{\includegraphics{graphics/lat2xyzdotted.pdf}}\hfill\mbox{}\\


\begin{figure}[th]
  \centering%
  \includegraphics{graphics/lattopxyz.pdf}%
  \caption{
...
\begin{tabular}{c||c|c|c|c}
  ...
  \\\hline
    \includegraphics{graphics/butterfly_setA.pdf}%
  & \includegraphics{graphics/butterfly_clsA.pdf}%
  & \includegraphics{graphics/butterfly_intA.pdf}%
  & \includegraphics{graphics/butterfly_bndA.pdf}%
  & \includegraphics{graphics/butterfly_drvA.pdf}%
  \\
...
\exbox{%
\begin{tabular}{ccc}
  \includegraphics{graphics/cont_yx.pdf}%
 &\includegraphics{graphics/cont_yfy.pdf}%
 &\includegraphics{graphics/cont_ydy.pdf}%
 \\%
