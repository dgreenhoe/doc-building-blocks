...
\begin{pspicture}(-3.50,-1.35)(1.90,0.55)
  ...
  \pnode(-0.50,-1.00){X}% signal input  label location
  \pnode( 1.50, 0.00){Y}% signal output label location
  \pnode(-2.50,-1.00){W}% noise  input  label location
  \pnode(-1.50, 0.00){A}% signal output near h(n) label location
  %-------------------------------------
  % label text
  %-------------------------------------
  \uput[  0](X) {$\rvx(n)$}% signal input  label
  \uput[-90](Y) {$\rvy(n)$}% signal output label
  \uput[180](W) {$\rvw(n)$}% input  noise  label
