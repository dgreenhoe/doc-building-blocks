...
%============================================================================
{\psset{xunit=0.16mm,yunit=0.19mm}%
\begin{pspicture}(-450,-40)(450,540)%
  ...
  % nodes
  %---------------------------------
  \Cnode[fillstyle=solid,fillcolor=lgray](   0,500){T77}%
  %
  \Cnode( 200,420){T66}%
  \Cnode( 350,400){T56}%
  \Cnode( 100,420){T65}%
  ...
  \Cnode( 300,200){T44}%
  \Cnode( 200,200){T24}%
  \Cnode[fillstyle=solid,fillcolor=lgray]( 400,250){T14}%
  \Cnode( 100,200){T42}%
  \Cnode[fillstyle=solid,fillcolor=lgray](   0,200){T22}%
  \Cnode(-100,200){T12}%
  \Cnode[fillstyle=solid,fillcolor=lgray](-400,250){T41}%
  \Cnode(-200,200){T21}%
  \Cnode(-300,200){T11}%
  %
  ...
  \Cnode[fillstyle=solid,fillcolor=lgray](   0,0)  {T00}%
  %---------------------------------
  % node connections
  %---------------------------------
  \ncline{T77}{T33}%
