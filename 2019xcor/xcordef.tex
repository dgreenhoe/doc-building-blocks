...
%20190509%\\
%20190509%    (8).\quad\Szty(z)
%20190509%      &\eqd \opZ\Rty(m)
%20190509%     &&\eqd \opZ\pE\brs{\rvt^\ast(m)\rvy^\ast(0)}
%20190509%       \mathrlap{\qquad=    \opZ\pE\brs{\rvt^\ast(m)\brp{\sum_{k\in\Z} \fh^\ast(k) \rvx^\ast(0-k)}}}
%20190509%    \\&=    \opZ\sum_{k\in\Z} \fh^\ast(k) \pE\brs{\rvt^\ast(m)\rvx^\ast(-k)}
%20190509%     &&=    \opZ\sum_{k\in\Z} \fh^\ast(k) \pE\brs{\rvt^\ast(0)\rvx^\ast(-m-k)}
%20190509%    \\&=    \opZ\sum_{k\in\Z} \fh^\ast(k) \pE\brs{\rvt^\ast(-m-k)\rvx^\ast(0)}
%20190509%     &&\eqd \opZ                    \sum_{k\in\Z} \fh^\ast(k) \Rtx^\ast(-m-k)
%20190509%     &&=    \opZ                    \sum_{k\in\Z} \fh^\ast(k) \Rtx(m+k)
%20190509%    \\&\eqd \opZ\brs{\fh(-m) \convd \Rtx(m)}
%20190509%     &&= \opZ\brs{\fh(-m) \convd \Rtx(m)}
%20190509%     &&= \brs{\opZ\fh(-m)} \brs{\opZ\Rtx(m)}
%20190509%    \\&= \ZH\brp{\frac{1}{z}} \Sztx(z)
\\
    (8).\quad\Szyt(z)
      &\eqd \opZ\Ryt(m)
