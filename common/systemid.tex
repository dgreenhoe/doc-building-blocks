...
\\
As a first attempt at estimating the transfer function $\fH$, 
...
(next definition).
%---------------------------------------
\begin{definition}[\fnctd{transmissibility}]
\footnote{
...
And so to start (again), and in the very special (a.k.a unrealistic) case of $\opS$ having \prope{zero measurement noise}
($\rvu(n)=\rvv(n)=0$),
