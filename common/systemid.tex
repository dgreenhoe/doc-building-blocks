...
\thmbox{\begin{array}{M}
  $\ds\brb{s_1 < s_2} 
  \qquad\implies\qquad
  \estHs(\omega;s_1) \le \estHs(\omega;s_2)$
  \\
  ...
  \item lemma: derivative of $\estHs$ with respect to $p\eqd s^2$ \ldots
    {\begin{align*}
      ...
      \\&\eqd \ddp\frac{\Swyy - p \Swxx  +
                          \sqrt{\brs{\Swyy  -  p \Swxx }^2 + 4 p \abs{\Swxy }^2}
                       }{2\Swxy }
        && \text{by definition of $p$}
        && \text{\xref{item:Hs_mono_p}}
      \\&= \frac{\ds- \Swxx  + \frac{-2\Swxx\brs{\Swyy  -  p \Swxx } + 4 \abs{\Swxy }^2}
                                    {2\sqrt{\brs{\Swyy  -  p \Swxx }^2 + 4 p \abs{\Swxy }^2}}
                }{\ds2\Swxy }
      \\&= \frac{4 \abs{\Swxy }^2   -2\Swxx\brp{\Swyy  -  p \Swxx} - 2\Swxx\sqrt{\brp{\Swyy  -  p \Swxx }^2 + 4 p \abs{\Swxy }^2}}
                {4\Swxy\sqrt{\brs{\Swyy  -  p \Swxx }^2 + 4 p \abs{\Swxy }^2}}
      \\&\le \frac{4 \abs{\Swxy }^2   -2\Swxx\brs{\brp{\Swyy  -  p \Swxx} + \sqrt{\brp{\Swyy  -  p \Swxx }^2 }}}
                  {4\Swxy\sqrt{\brs{\Swyy  -  p \Swxx }^2 + 4 p \abs{\Swxy }^2}}
      \\&=   \frac{\abs{\Swxy }^2   -\Swxx\brs{\brp{\Swyy  -  p \Swxx} }}
                  {\Swxy\sqrt{\brs{\Swyy  -  p \Swxx }^2 + 4 p \abs{\Swxy }^2}}
    \end{align*}}
\end{enumerate}
\end{proof}
