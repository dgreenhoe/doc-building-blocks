...
\begin{pspicture}(-450,-38)(450,540)%
  ...
  \Cnode[fillcolor=greenbright](-300,300){T13}%\Cnode( 100,300){T13}%
  ...
  \Cnode[fillcolor=greenbright]( 350, 75){T04}%  %\Cnode(-100,100){T04}%
  \Cnode(-100, 75){T02}%  %\Cnode(-200,100){T02}%
  \Cnode[fillcolor=greenbright](-350, 75){T01}%  %\Cnode(-300,100){T01}%
