...
\thmbox{
  ...
  \brb{\begin{array}{FrclDD}
    ...
    \\(3).& \var\brs{\varest\seqn{\rvx_n}} &=& \mc{3}{l}{\ds\frac{1}{\xN}\brs{\mu^4 - \sigma^4\brp{\frac{\xN-3}{\xN-1}}}}
  \end{array}}
  }
\end{theorem}
\begin{proof}
  ...
  \item Proof for (3):
    {\begin{align*}
      ...
      \\&= \pE\brs{\brp{\varest}^2} - 2\brp{\pvar}^2 + \brp{\pvar}^2
        && \text{by (2)}
        && \text{\xref{item:varest}}
      \\&= \brs{\frac{\mu^4}{\xN} + \frac{(\xN-1)^2+2}{\xN(\xN-1)} \sigma^4} - \sigma^4 
        && \text{by \pref{ilem:varest_varvar}}
      \\&= \frac{1}{\xN}\brs{\mu^4 - \sigma^4\brp{\frac{\xN-3}{\xN-1}}}
    \end{align*}}
\end{enumerate}
\end{proof}
