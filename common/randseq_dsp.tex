...
%============================================================================
%=======================================
\chapter{Operators on Random Sequences}
%=======================================
%=======================================
...
\thmbox{
  \brb{\begin{array}{FMMD}
    ...
    \\(C).& \mc{3}{M}{$\ds\opH\kdelta(n)=\sum_{m\in\Z}\fh(m)\kdelta(n-m)$}
    \\    & \mc{3}{D}{(\fncte{impulse response})}
  \end{array}}
  \implies
...
%=======================================
\section{Whitening operators on random sequences}
