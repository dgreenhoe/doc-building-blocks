...
\begin{pspicture}(-1.5,-1.5)(1.75,1.5)%
  ...
  \uput{1.0}[-60](origin){\pnode(0,0){circleP}}% circle point
  \uput{1.5}[-50](origin){\pnode(0,0){circleL}}% circle point
  \uput{1.0}[ 45](origin){\pnode(0,0){root1}}%
  \uput{1.0}[135](origin){\pnode(0,0){root2}}%
  \uput{1.0}[225](origin){\pnode(0,0){root3}}%
  \uput{1.0}[315](origin){\pnode(0,0){root4}}%
  %-------------------------------------
  % axes
  %-------------------------------------
  ...
  \rput[tl](circleL){$\scy\abs{x}=1$}% circle label
