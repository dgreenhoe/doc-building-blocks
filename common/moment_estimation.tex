...
\thmbox{
  \cmomest_{p,n}
    = \frac{1}{n}\sum_{k=1}^n \bcoef{p}{m}
      \brs{ -\frac{1}{n}\brp{\rvx_n-\cmomest_{n-1}} }^m
...
\begin{align*}
  ...
  \\&= \cancelto{1}{\bcoef{2}{0}} 1 \brs{ (n-1) \cmomest_{2,n-1} + \brp{ \rvx_n - \meanest_{n-1} }^{2} }
     + \cancelto{2}{\bcoef{2}{1}} \brs{ -\frac{1}{n}\brp{\rvx_n-\cmomest_{n-1}} }   \brs{ (n-1) \cancelto{0}{\cmomest_{1,n-1}} + \brp{ \rvx_n - \meanest_{n-1} } }
       \\&\qquad
     + \cancelto{1}{\bcoef{2}{2}} \brs{ -\frac{1}{n}\brp{\rvx_n-\cmomest_{n-1}} }^2 \brs{ (n-1) \cancelto{1}{\cmomest_{0,n-1}} + 1 }
  \\&= (n-1) \cmomest_{2,n-1}
...
\thmbox{
  \meanest_{3,n} =
      \frac{n-1}{n}\cmomest_{3,n-1}
    - \frac{3(n-1)}{n^2}  \brp{ \rvx_n-\meanest_{n-1} } \cmomest_{2,n-1}
...
\begin{align*}
  ...
  \\&=             \bcoef{3}{0} \brs{ -\frac{1}{n}\brp{\rvx_n-\meanest_{n-1}} }^0 \brs{ (n-1) \cmomest_{3-0,n-1} + \brp{ \rvx_n - \meanest_{n-1} }^{3-0} }
       ...
       \\&\qquad + \bcoef{3}{3} \brs{ -\frac{1}{n}\brp{\rvx_n-\meanest_{n-1}} }^3 \brs{ (n-1) \cancelto{1}{\cmomest_{3-3,n-1}} + \brp{ \rvx_n - \meanest_{n-1} }^{3-3} }
  \\&=                                             \brs{ (n-1) \cmomest_{3,n-1} + \brp{ \rvx_n - \meanest_{n-1} }^3 }
     - \frac{3}{n  } \brp{\rvx_n-\cmomest_{n-1}}   \brs{ (n-1) \cmomest_{2,n-1} + \brp{ \rvx_n - \meanest_{n-1} }^2 }
       \\&\qquad
     + \frac{3}{n^2} \brp{\rvx_n-\cmomest_{n-1}}^2 \brs{                          \brp{ \rvx_n - \meanest_{n-1} }   }
     - \frac{1}{n^3} \brp{\rvx_n-\cmomest_{n-1}}^3 \brs{ (n-1)                  + 1                                 }
  \\&= (n-1)\cmomest_{3,n-1}
  ...
  \\&= (n-1)\cmomest_{3,n-1}
     ...
     - \frac{3(n-1)}{n} \brp{ \rvx_n - \meanest_{n-1} } \cmomest_{2,n-1}
  \\&= (n-1)\cmomest_{3,n-1}
     - \frac{3n-3}{n} \brp{ \rvx_n - \meanest_{n-1} } \cmomest_{2,n-1}
...
\thmbox{\begin{array}{rc>{\ds}l}
 \cmomest_{4,n} &=&
      \frac{n-1}{n}\cmomest_{4,n-1}
    + \brs{ \frac{n^3 -4n^2 +6n -3}{n^4} }\brp{ \rvx_n - \meanest_{n-1} }^4
    - \frac{4(n-1)}{n^2  } \brp{ \rvx_n-\meanest_{n-1} }\cmomest_{3,n-1}
    \\&&
    + \frac{6(n-1)}{n^3} \brp{ \rvx_n-\meanest_{n-1} }^2 \cmomest_{2,n-1}
\end{array}}
\end{theorem}
\begin{proof}
...
%  \\&= \bcoef{4}{0}\brs{ -\frac{1}{n}\brp{\rvx_n-\cmomest_{n-1}} }^0 \brs{ (n-1) \cmomest_{4-0,n-1} + \brp{ \rvx_n - \meanest_{n-1} }^{4-0} }
%       \bcoef{4}{1}\brs{ -\frac{1}{n}\brp{\rvx_n-\cmomest_{n-1}} }^1 \brs{ (n-1) \cmomest_{4-1,n-1} + \brp{ \rvx_n - \meanest_{n-1} }^{4-1} }
%       \bcoef{4}{2}\brs{ -\frac{1}{n}\brp{\rvx_n-\cmomest_{n-1}} }^2 \brs{ (n-1) \cmomest_{4-2,n-1} + \brp{ \rvx_n - \meanest_{n-1} }^{4-2} }
%       \bcoef{4}{3}\brs{ -\frac{1}{n}\brp{\rvx_n-\cmomest_{n-1}} }^3 \brs{ (n-1) \cmomest_{4-3,n-1} + \brp{ \rvx_n - \meanest_{n-1} }^{4-3} }
%       \bcoef{4}{4}\brs{ -\frac{1}{n}\brp{\rvx_n-\cmomest_{n-1}} }^4 \brs{ (n-1) \cmomest_{4-4,n-1} + \brp{ \rvx_n - \meanest_{n-1} }^{4-4} }
%\end{align*}
