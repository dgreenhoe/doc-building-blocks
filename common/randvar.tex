...
\begin{figure}
  ...
  \begin{tabular}{c>{\Huge}c c>{\Huge}c l}%
    \tboxc{\includegraphics{graphics/pdf_fairdie_blue.pdf}} &\tbox{+}&%
    \tboxc{\includegraphics{graphics/pdf_fairdie_red.pdf}}  &\tbox{=}&%
    \tboxc{\includegraphics{graphics/pdf_dicesum_bluered.pdf}}% 
    \\
    \tboxc{\includegraphics{graphics/n0.pdf}}               &\tbox{+}&%
    \tboxc{\includegraphics{graphics/n0.pdf}}               &\tbox{=}&%
    \tboxc{\includegraphics{graphics/n1.pdf}}%              
    \\                                                      
    \tboxc{\includegraphics{graphics/n0.pdf}}               &\tbox{+}&%
    \tboxc{\includegraphics{graphics/n1.pdf}}               &\tbox{=}&%
    \tboxc{\includegraphics{graphics/n2.pdf}}%
  \end{tabular}
