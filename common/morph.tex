...
\label{thm:mph_add}
\footnote{
  \citerppg{pitas1991}{163}{164}{0792390490}
  }
%---------------------------------------
...
\footnote{
  \citerpg{pitas1991}{163}{0792390490}
  }
%---------------------------------------
Let $\opair{\setX}{+}$ be a group with with Minokowski addition operator $\oplus:\setX^2\to\setX$.
\thmbox{\begin{array}{rcl>{\qquad}C>{\qquad}D}
...
\label{thm:mph_sub}
\footnote{
  \citerppg{pitas1991}{164}{165}{0792390490}
  }
%---------------------------------------
...
\footnote{
  \citerpg{pitas1991}{165}{0792390490}
  }
%---------------------------------------
...
\footnote{
  \citerpg{pitas1991}{166}{0792390490}
  }
%---------------------------------------
...
\begin{definition}
\footnote{
  \citerpg{pitas1991}{161}{0792390490}
  }
\index[xsym]{$\check{D}$}
%---------------------------------------
Let $\opair{\setX}{+}$ be a group with
...
\begin{definition}
\footnote{
  %\citerpg{pitas1991}{167}{0792390490}
  \citerpg{serra1982}{50}{0126372403}
  }
\label{def:mph_open}
\label{def:mph_close}
%---------------------------------------
...
\footnote{
  %\citerpg{pitas1991}{167}{0792390490},
  \citerpg{serra1982}{51}{0126372403}
  }
%---------------------------------------
Let $\opair{\setX}{+}$ be a group with
