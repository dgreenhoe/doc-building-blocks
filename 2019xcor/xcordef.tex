...
\\\indentx$\begin{array}{FMM}
    \imark & We get 3 different relations between $\Ryx(m)$ and $\Rxy(m)$                                   & \xref{prop:Rxy}
  \\\imark & We get 2 different relations between $\Rxx(-m)$ and $\Rxx(m)$                                  & \xref{prop:Rxy}
  \\\imark & We get 4 different results for $\Szxy(z)$                                                      & \xref{prop:RxySzxy}
  \\\imark & We get 4 different results for $\Swxy(\omega)$                                                 & \xref{prop:RxySwxy}
...
\\
$\begin{array}{|Fc        l       c l@{\hspace{0pt}}c@{\hspace{0pt}}r D l    c l@{\hspace{0pt}}c@{\hspace{0pt}}r D|}
  \hline
