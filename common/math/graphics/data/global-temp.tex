...
\begin{pspicture}(1860,-1)(2025,1.45)%
  %-------------------------------------
  % grid
  %-------------------------------------
  \rput(1870,0){%
    \psset{linecolor=grid,linewidth=0.5pt}%
    \multirput{0}(0, -0.4)(0,0.2){9}{\psline[linestyle=dashed](0,0)(150,0)}% horizontal
    \multirput{0}(10,-0.6)(10,0){14}{\psline[linestyle=dotted](0,0)( 0,2)}% vertical
    \psline(0,0)(150,0)% horizontal x axis
  }%
  %-------------------------------------
  % axes
  %-------------------------------------
  {%
   ...
   %\psgrid(0,0)(1870,-0.6)(2020,1.4)%
    \psaxes[yAxis=false](0,-0.6)(1870,-0.6)(2020,1.4)% x-axis
    \psaxes[xAxis=false](1870,0)(1870,-0.6)(2020,1.4)% y-axis
 ...
 %\fileplot{../../common/math/graphics/data/global-temp.dat}%
  ...
  \psplot{1870}{2020}{0.00000034336 x 1880 sub 3 exp mul
