...
\label{prop:RxySzxy}
%---------------------------------------
\propbox{\begin{array}{FM   >{\ds}r  c     l *{3}{@{\hspace{0pt}}l}          c         >{\ds}r   c l @{\hspace{0pt}}c@{\hspace{0pt}}l    ll}
  ...
  \\(6).&alt-Bendat:      & \Rxy(m) &\eqd& \pE[\rvx     &(m)\rvy     &(0&)] &\implies& \Szxy(z) &=&
  \\(7).&Bendat-star      & \Rxy(m) &\eqd& \pE[\rvx^\ast&(0)\rvy^\ast&(m&)] &\implies& \Szxy(z) &=&
  \\(8).&alt-Bendat-star: & \Rxy(m) &\eqd& \pE[\rvx^\ast&(m)\rvy^\ast&(0&)] &\implies& \Szxy(z) &=&
\end{array}}
\end{proposition}
\begin{proof}
\begin{align*}
