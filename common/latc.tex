...
\end{array}$
\end{minipage}%
\hfill\tbox{\includegraphics{graphics/lat6_o6slash_123.pdf}}
\end{example}
...
\end{example}
\end{minipage}%
\hfill\tbox{\includegraphics{graphics/lat5_m3_xyz.pdf}}
...
\begin{tabular}{|*{9}{c}|}
  ...
  &\includegraphics{graphics/lat7_o7slash.pdf}%
  &\vline&\includegraphics{graphics/lat2_l2.pdf}%
