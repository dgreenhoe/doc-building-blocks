...
\begin{enumerate}
  ...
  \item Proof solving a system of equations:
    ...
    \item Proof using \prefpp{lem:van_factor} (and placing two zeros at $z=-1$):
      \begin{align*}
        \Zh(z)
...
\begin{enumerate}
  ...
  \item Proof solving a system of equations:
    ...
    \item Proof using \prefpp{lem:van_factor} (and placing three zeros at $z=-1$):
      \begin{align*}
        \Zh(z)
...
\begin{enumerate}
  ...
  \item Proof using \prefpp{lem:van_factor} (and placing four zeros at $z=-1$):
    \begin{align*}
      \Zh(z)
