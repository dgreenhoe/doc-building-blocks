...
\qboxns
  ...
  \citetblt{
    \citerpu{aristotleMeta4}{4.1005b}{http://www.perseus.tufts.edu/cgi-bin/ptext?lookup=Aristot.+Met.+4.1005b}
...
\begin{figure}
  \begin{center}
    \psset{xunit=12mm,yunit=18mm}\gsize\input{../common/math/graphics/latnegations.tex}
   %\includegraphics{../common/math/graphics/pdfs/latnegations.pdf}% warning: crosslinks (Def... page...) lost when compiling separately
  \end{center}
...
Let $\latL\eqd\latbX$ be a \structe{bounded lattice} \ifsxref{latb}{def:latb}.
\defbox{
...
%\label{def:latorm}
%---------------------------------------
Let $\latL\eqd\latnX$ be a \structe{bounded lattice} \ifsxref{latb}{def:latb} with a function $\negat$ in $\clFxx$.
%Let $\negat$ be a function on a \structe{bounded lattice} $\latbX$ \ifsxref{latb}{def:latb}.
%Let $\latL\eqd\latnX$.
\defboxt{
  %\begin{array}{MM}
...
%---------------------------------------
Let $\negat\in\clFxx$ be a function on a \structe{bounded lattice} $\latL\eqd\latbX$ \ifsxref{latb}{def:latb}.
\lembox{
...
\exbox{
  ...
  \begin{array}{M}
  \psset{yunit=5mm}%
  \includegraphics{../common/math/graphics/pdfs/lat2_L2_10_-0-1.pdf}
  \end{array}
  }
\end{example}
\begin{proof}
...
\exbox{
  ...
  % \includegraphics{../common/math/graphics/pdfs/lat3_L3_1=-1_x=-x_0=-0.pdf}
  %&\includegraphics{../common/math/graphics/pdfs/lat3_L3_1=-0_x=-1_0=-x.pdf}
  %&\includegraphics{../common/math/graphics/pdfs/lat3_L3_1=-x_x=-0_0=-1.pdf}
   \includegraphics{../common/math/graphics/pdfs/lat3_L3_1-1_x-x_0-0.pdf}
  &\includegraphics{../common/math/graphics/pdfs/lat3_L3_1-0_x-1_0-x.pdf}
  &\includegraphics{../common/math/graphics/pdfs/lat3_L3_1-x_x-0_0-1.pdf}
...
\exbox{
  ...
  \begin{array}{M}
   \psset{unit=5mm}
   %\includegraphics{../common/math/graphics/pdfs/lat6_o6_1=-0_a=-b_b=-a_c=-d_d=-c_0=-1.pdf}
   \includegraphics{../common/math/graphics/pdfs/lat6_o6_1-0_a-b_b-a_c-d_d-c_0-1.pdf}
  \end{array}
  }
\end{example}
...
\exbox{
  ...
  \begin{array}{*{3}{>{\psset{yunit=5mm}}M}}
     \includegraphics{../common/math/graphics/pdfs/lat3_L3_1x0_-0-1-x.pdf}
    &\includegraphics{../common/math/graphics/pdfs/lat3_L3_1x0_-1x0.pdf}
    &\includegraphics{../common/math/graphics/pdfs/lat3_L3_1-0-a_a_0-1.pdf}
  \\\mbox{}\quad\scs(a)&\mbox{}\quad\scs(b)&\mbox{}\quad\scs(c)
  \end{array}
  }
\end{example}
...
\begin{figure}%
  ...
  \begin{tabstr}{0.75}
    \begin{tabular}{*{4}{>{\scs}c}}
       \includegraphics{../common/math/graphics/pdfs/lat3_L3_1-a-0_a-1_0.pdf}
      &\includegraphics{../common/math/graphics/pdfs/lat3_L3_1x0_-0-x-1.pdf}
      &\includegraphics{../common/math/graphics/pdfs/lat3_L3_1_a-0_0-1-a.pdf}
      &\includegraphics{../common/math/graphics/pdfs/lat3_L3_1-0_a_0-1-x.pdf}
      \\
...
\begin{figure}
  ...
  \begin{tabstr}{0.75}%
    \begin{tabular}{*{3}{>{\scs}c}}
       \includegraphics{../common/math/graphics/pdfs/lat4_m2_1-0_a_b-b_0-1-a.pdf}
      &\includegraphics{../common/math/graphics/pdfs/lat4_m2_a-b_b-a.pdf}
      &\includegraphics{../common/math/graphics/pdfs/lat4_bn4_a-a_b-b.pdf}
      \\
...
Note that 
$\begin{array}{NcNcN}
  \psset{unit=5mm}\includegraphics{../common/math/graphics/pdfs/lat4_m2_1-0_a_b-b_0-1-a.pdf}
  &\raisebox{5mm}{=}&
  \psset{unit=5mm}\includegraphics{../common/math/graphics/pdfs/lat3_L3_1-0_a_0-1-x.pdf}
  &\raisebox{5mm}{+}&
  \psset{unit=5mm}\includegraphics{../common/math/graphics/pdfs/lat3_L3_1x0_-0-x-1.pdf}
...
\exbox{
  \begin{array}{M}%
  \psset{unit=7.5mm}%
  \includegraphics{../common/math/graphics/pdfs/lat5_m3_negdm.pdf}%
  \end{array}%
  ...
  \begin{array}{M}%
  \psset{unit=7.5mm}%
  \includegraphics{../common/math/graphics/pdfs/lat5_m3_negkl.pdf}%
  \end{array}%
  }
\end{example}
...
\exbox{
  \begin{array}{M}
   \psset{unit=5mm}
   \includegraphics{../common/math/graphics/pdfs/lat6_o6_negdm.pdf}
  \end{array}
  ...
  \begin{array}{M}
   \psset{unit=5mm}
   \includegraphics{../common/math/graphics/pdfs/lat6_o6_negor.pdf}
  \end{array}
  }
\end{example}
...
\exbox{
  \begin{array}{M}
   \psset{unit=5mm}
   \includegraphics{../common/math/graphics/pdfs/lat6_o6slash_nonantitone.pdf}
  \end{array}
  \begin{array}{m{\tw-83mm}}
  ...
  \begin{array}{M}
   \psset{unit=5mm}
   \includegraphics{../common/math/graphics/pdfs/lat6_o6slash_kleene.pdf}
  \end{array}
  }
\end{example}
\begin{proof}
...
\exbox{
  \begin{array}{M}%
  \psset{unit=7.5mm}%
  \includegraphics{../common/math/graphics/pdfs/lat8_l2e3_abc_dm.pdf}%
  \end{array}%
  ...
  \begin{array}{M}%
  \psset{unit=7.5mm}%
  \includegraphics{../common/math/graphics/pdfs/lat8_l2e3_abc_ortho.pdf}%
  \end{array}%
  }
\end{example}
\begin{proof}
