...
\exbox{
  ...
  = \frac{1}{\sqrt{2\pi}}\frac{2\alpha}{\alpha^2+\omega^2}
  }
\end{example}
\begin{proof}
\begin{align*}
  \fG(\omega)
    &\eqd \frac{1}{\sqrt{2\pi}}\int_{-\infty}^{\infty}\fg(\tau)e^{-j\omega\tau}\dtau
    && \text{by definition Fourier Transform}
  \\&\eqd \frac{1}{\sqrt{2\pi}}\int_{-\infty}^{\infty} e^{-\alpha\abs{\tau}} e^{-j\omega\tau}\dtau
    && \text{by definition of $\fg(\tau)$}
  \\&= \frac{1}{\sqrt{2\pi}}\int_{-\infty}^{0} e^{-\alpha(-\tau)} e^{-j\omega\tau}\dtau
     + \frac{1}{\sqrt{2\pi}}\int_{0}^{\infty} e^{-\alpha(\tau)} e^{-j\omega\tau}\dtau
  \\&= \frac{1}{\sqrt{2\pi}}\int_{-\infty}^{0} e^{\tau(\alpha-j\omega)}\dtau
     + \frac{1}{\sqrt{2\pi}}\int_{0}^{\infty} e^{\tau(-\alpha-j\omega)}\dtau
  \\&= \frac{1}{\sqrt{2\pi}}\brlr{\frac{e^{\tau(\alpha-j\omega)}}{\alpha-j\omega}}_{-\infty}^{0} 
     + \frac{1}{\sqrt{2\pi}}\brlr{\frac{e^{\tau(-\alpha-j\omega)}}{-\alpha-j\omega}}_{0}^{\infty} 
    && \text{by Fundamental Theorem of Calculus}
  \\&= \frac{1}{\sqrt{2\pi}}\brs{\frac{1}{\alpha-j\omega} - 0}
     + \frac{1}{\sqrt{2\pi}}\brs{0- \frac{1}{-\alpha-j\omega}}
  \\&= \frac{1}{\sqrt{2\pi}}\brs{\frac{1}{\alpha-j\omega}}\brs{\frac{\alpha-j\omega}{\alpha-j\omega}}
     + \frac{1}{\sqrt{2\pi}}\brs{\frac{1}{\alpha+j\omega}}\brs{\frac{\alpha+j\omega}{\alpha+j\omega}}
  \\&= \frac{1}{\sqrt{2\pi}}\frac{\alpha-j\omega}{\alpha^2+\omega^2}
     + \frac{1}{\sqrt{2\pi}}\frac{\alpha+j\omega}{\alpha^2+\omega^2}
  \\&= \boxed{\frac{1}{\sqrt{2\pi}}\frac{2\alpha}{\alpha^2+\omega^2}}
\end{align*}
\end{proof}
