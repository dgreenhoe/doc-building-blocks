...
\\\indentx
  \begin{tabular}{|*{2}{>{\scs}c|}}
    \hline
      \includegraphics{ssp/graphics/seq_lprect16.pdf} 
     &\includegraphics{ssp/graphics/seq_hprect16.pdf}
...
\\\mbox{}\hfill\includegraphics{ssp/graphics/hanninglp50.pdf}\hfill\mbox{}
\end{example}
...
\\\mbox{}\hfill\includegraphics{ssp/graphics/hanninghp50.pdf}\hfill\mbox{}
\end{example}
...
%  \begin{tabular}{|*{2}{>{\scs}c|}}
%    \hline
%      \includegraphics{ssp/graphics/seq_shaar16.pdf} 
%     &\includegraphics{ssp/graphics/seq_whaar16.pdf}
...
\\\indentx
  \begin{tabular}{|*{3}{>{\scs}c|}}
    \hline
      \includegraphics{ssp/graphics/seq_shaar8.pdf} 
     &\includegraphics{ssp/graphics/seq_whaar8.pdf}
     &\includegraphics{ssp/graphics/seq_whaar9.pdf}
