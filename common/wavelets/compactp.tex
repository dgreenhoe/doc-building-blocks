...
\begin{enumerate}
  ...
  \item Compute $P\left(\frac{2-z-z^{-1}}{4}\right)$.
        ...
        {\center \input{../common/wavelets/graphics/2p2roots.tex} }
    ...
    \item Because the coefficients of
          ...
          \begin{picture}(300,300)(-130,-130)
            ...
            \color{axis}%  
              ...
              \qbezier[30](0,0)(62.5,-62.5)(125,-125)%
            \color{circle}%
              \input{../common/wavelets/graphics/circle.tex}%
...
%\end{picture}
%&\includegraphics{graphics/Dp_pz.pdf}
%\\
...
%\end{center}
%\caption{
%   Zero locations for B-cardinal spline $N_p(t)$ (left) and
%   Daubechies-p (right) scaling coefficients
%   \label{fig:spline_zero_b}
%   }
%\end{figure}
...
%\begin{center}
%  \setlength{\unitlength}{0.15mm}
%  \input{../common/wavelets/graphics/Dp_pz.tex}
%\end{center}
%\caption{
...
%  \endlastfoot
%    \raisebox{15mm}{5}
%    & \psset{xunit=4mm,yunit=10mm}\input{../common/wavelets/graphics/d5_phi_h.tex}
%    & \psset{xunit=4mm,yunit=10mm}\input{../common/wavelets/graphics/d5_psi_g.tex}
%    \\
%    \raisebox{15mm}{6}
%    & \psset{xunit=4mm,yunit=10mm}\input{../common/wavelets/graphics/d6_phi_h.tex}
%    & \psset{xunit=4mm,yunit=10mm}\input{../common/wavelets/graphics/d6_psi_g.tex}
%    \\
%    \raisebox{15mm}{7}
%    & \psset{xunit=4mm,yunit=10mm}\input{../common/wavelets/graphics/d7_phi_h.tex}
%    & \psset{xunit=4mm,yunit=10mm}\input{../common/wavelets/graphics/d7_psi_g.tex}
%    \\
%    \raisebox{15mm}{8}
%    & \psset{xunit=4mm,yunit=10mm}\input{../common/wavelets/graphics/d8_phi_h.tex}
%    & \psset{xunit=4mm,yunit=10mm}\input{../common/wavelets/graphics/d8_psi_g.tex}
%    \\
%    \raisebox{15mm}{9}
%    & \psset{xunit=3mm,yunit=10mm}\input{../common/wavelets/graphics/d9_phi_h.tex}
%    & \psset{xunit=3mm,yunit=10mm}\input{../common/wavelets/graphics/d9_psi_g.tex}
%    \\
%    \raisebox{15mm}{10}
%    & \psset{xunit=3mm,yunit=10mm}\input{../common/wavelets/graphics/d10_phi_h.tex}
%    & \psset{xunit=3mm,yunit=10mm}\input{../common/wavelets/graphics/d10_psi_g.tex}
%    \\
%    \raisebox{15mm}{11}
%    & \psset{xunit=3mm,yunit=10mm}\input{../common/wavelets/graphics/d11_phi_h.tex}
%    & \psset{xunit=3mm,yunit=10mm}\input{../common/wavelets/graphics/d11_psi_g.tex}
%    \\
%%    \raisebox{15mm}{12}
%%    & \psset{xunit=3mm,yunit=10mm}\input{../common/wavelets/graphics/d12_phi_h.tex}
%%    & \psset{xunit=3mm,yunit=10mm}\input{../common/wavelets/graphics/d12_psi_g.tex}
%    \\\hline
%\end{longtable}
