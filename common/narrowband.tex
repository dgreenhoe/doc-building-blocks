...
\defbox{
\begin{array}{FMl}
   1. & \fnctd{amplitude and phase}:     & \fx(t) = \fa(t)\cos\left[ 2\pi f_c t + \theta(t) \right]    \\
   2. & \fnctd{quadrature}:\footnotemark & \fx(t) = \fp(t)\cos(2\pi f_c t) - \fq(t)\sin(2\pi f_c t)    \\
   3. & \fnctd{complex envelope}:        & \fx(t) = \Reb{\fx_l(t)e^{i2\pi f_c t}}.
\end{array}
}
   \footnotetext{
