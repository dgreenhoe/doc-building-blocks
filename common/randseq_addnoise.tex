...
%=======================================
%=======================================
%\section{Additive noise and expectation}
%=======================================
%=======================================
\section{Additive noise and correlation}
%=======================================
%---------------------------------------
...
\end{theorem}
\end{minipage}
\qquad\tbox{\includegraphics{../common/math/graphics/pdfs/sys_xvy.pdf}}
\thmbox{
  ...
  \brbl{\begin{array}{FrclD}
      (1).&\Ryv(m) &=&           \Rvv(m)           & and
    \\(2).&\Rxy(m) &=&           \Rxx(m)           & and
    \\(3).&\Ryy(m) &=&           \Rxx(m) + \Rvv(m) & and
    \\(4).&\Rxx(m) &=& \mc{2}{l}{\Ryy(m) + \Rvv(m) - 2\Real\Ryv(m)}
  \end{array}}
  }
\\
\begin{proof}
...
\end{theorem}
\end{minipage}
\qquad\tbox{\includegraphics{../common/math/graphics/pdfs/dual_addnoise.pdf}}
\thmbox{
...
\begin{figure}[ht]
  ...
  \begin{tabular}{|c|c|c|}
    \hline
      \includegraphics{../common/math/graphics/pdfs/sysT_xyvq.pdf}
     &\includegraphics{../common/math/graphics/pdfs/sysT_xyup.pdf}
     &\includegraphics{../common/math/graphics/pdfs/sysT_xypw.pdf}
...
\begin{figure}[ht]
  ...
  \begin{tabular}{|l|l|}
     \hline
     \mc{1}{|c|}{\tbox{\includegraphics{../common/math/graphics/pdfs/opT_cnoise.pdf}}}%
    &\mc{1}{|c|}{\tbox{\includegraphics{../common/math/graphics/pdfs/opT_mnoise.pdf}}}%
   \\
   ...
   \\\hline
  \end{tabular}
\caption{\prope{linear} / \propb{non-linear} additive noise systems\label{fig:opT_addnoise2}}
\end{figure}
...
%---------------------------------------
\mbox{}\\Let $\opS$ be the \structe{system} illustrated in \prefp{fig:opT_addnoise2} (A).
\thmbox{
...
%---------------------------------------
\mbox{}\\Let $\opS$ be the \structe{system} illustrated in \prefp{fig:opT_addnoise2} (B).
\thmbox{
  \brbr{\begin{array}{FMMD}
      (A).& $\rvx(n)$               is  & \prope{WSS}           & and
    \\(B).& $\rvu(n)$               is  & \prope{zero-mean}     & and
...
\begin{figure}[ht]
  ...
  \begin{tabular}{|l|l|l|}
    \hline
      \includegraphics{../common/math/graphics/pdfs/sysH_xyvq.pdf}
     &\includegraphics{../common/math/graphics/pdfs/sysH_xyup.pdf}
     &\includegraphics{../common/math/graphics/pdfs/sysH_xypw.pdf}
...
\begin{figure}[ht]
  ...
  \begin{tabular}{|c|c|}
     \hline
     \tbox{\includegraphics{../common/math/graphics/pdfs/sysH_cnoise.pdf}}%
    &\tbox{\includegraphics{../common/math/graphics/pdfs/sysH_mnoise.pdf}}%
   \\
...
\begin{figure}[ht]
  ...
  \begin{tabular}{|c|c|}
     \hline
     \includegraphics{../common/math/graphics/pdfs/opT_opH_cnoise.pdf}%
    &\includegraphics{../common/math/graphics/pdfs/opT_opH_mnoise.pdf}%
   \\
...
%\hfill\tbox{\includegraphics{../common/math/graphics/pdfs/xGy_xHw_addnoise.pdf}}
\corbox{
  \brb{\begin{array}{FMMD}
