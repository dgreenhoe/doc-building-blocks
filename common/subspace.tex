    ...
    \begin{enumerate}
      ...
      \item Proof that $\setAo=\clsAo$:
        \begin{enumerate}
          ...
          \item Because $\setAo$ contains all its limit points, and by the \thme{Closed Set Theorem}\ifsxref{seq}{thm:cst},
...
%---------------------------------------
Let $\spH\eqd\HspaceX$ be a \structe{Hilbert space}\ifsxref{seq}{def:hspace}.\\
