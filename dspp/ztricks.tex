...
\end{tabular}
\vfill
\includegraphics[height=68mm]{../common/graphics/misc/wizard_dragon_4953570.jpg}
\vfill\mbox{}
...
%---------------------------------------
\newpage\mbox{}\vfill
\includegraphics[height=\textheight-20mm]{graphics/oplat.pdf}
\vfill\mbox{}
%---------------------------------------
...
\includegraphics[height=100mm]{graphics/iir2n.pdf}
...
\includegraphics[height=120mm]{graphics/dfI_order2_156.pdf}

%---------------------------------------
\section*{Trick \# 2: The mirror trick}
%---------------------------------------
  \includegraphics[height=80mm]{graphics/pz_minphase.pdf}%
...
\includegraphics[height=80mm]{graphics/pz_realcoefs_11.pdf}
...
\vfill
\begin{tabular}{cc}
    \includegraphics[height=80mm]{graphics/pz_unstable.pdf}%
   &\includegraphics[height=80mm]{graphics/pz_stable.pdf}%
  \\\prope{unstable}&\prope{stable}
  \\\includegraphics[height=30mm]{../common/graphics/emotions/bear_surprisedL_4955791.jpg}
   &\includegraphics[height=30mm]{../common/graphics/emotions/bear_happy_4954937.jpg}
\end{tabular}
\vfill\mbox{}
...
%---------------------------------------
\begin{tabular}{cc}
  \includegraphics[height=80mm]{graphics/pz_realcoefs.pdf}%
  &\includegraphics[height=80mm]{graphics/pz_minphase.pdf}%
...
\vfill
$\begin{array}{ccccc}
     \tbox{\includegraphics[height=60mm]{graphics/pz_minphase.pdf}}
    &\tbox{$\times$}&
     \tbox{\includegraphics[height=60mm]{graphics/pz_minphase_inv.pdf}}
    &\tbox{$=$}&
     \tbox{$1$}
  \\
...
\vfill
\begin{tabular}{ccccc}
     \tbox{\includegraphics[height=60mm]{graphics/pz_unstable2.pdf}}
    &\tbox{$\times$}&
     \tbox{\includegraphics[height=60mm]{graphics/pz_allpass.pdf}}
    &\tbox{$=$}&
     \tbox{\includegraphics[height=60mm]{graphics/pz_unall.pdf}}
  \\unstable&&all-pass&&stable!
  \\\includegraphics[height=30mm]{../common/graphics/emotions/bear_surprisedL_4955791.jpg}
    &&
    \includegraphics[height=50mm]{../common/graphics/superhero/rush_superhero_4954908.jpg}
    &&
    \includegraphics[height=30mm]{../common/graphics/emotions/bear_happy_4954937.jpg}
\end{tabular}
\vfill\mbox{}
...
\vfill
\includegraphics[height=110mm]{graphics/dfI_order2_fir.pdf}
...
\end{align*}
\vfill
\includegraphics[height=100mm]{graphics/pz_pole00.pdf}
...
%\includegraphics[height=120mm]{graphics/}
