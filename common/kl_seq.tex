...
\begin{example}
%---------------------------------------
Sunspot data:\footnote{\citer{wdcsilo_sunspot2021may}}
\\\includegraphics[width=\tw]{../common/math/graphics/pdfs/sunspots.pdf}
\\
Auto-correlation function: Other than at lag=0, the greatest\footnote{$20\log_{10}\brp{\frac{0.5918556724}{0.3730703718}}\eqa4.01$dB greater}
 correlation occurs at 10.42 years \ldots implying a sunspot oscillation with estimated period 10.42 years.
\\\includegraphics[width=\tw]{../common/math/graphics/pdfs/sunspots_acf.pdf}
\end{example}
