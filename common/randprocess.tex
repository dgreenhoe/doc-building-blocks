...
\defboxt{
  ...
  \\\indentx$\ds\pE\brs{\rvx(t)} = \lim_{\tau\to\infty}\frac{1}{2\tau}\int_{-\tau}^{+\tau}\rvx(t)\dt$
  }
\end{definition}

%20181127%%---------------------------------------
%20181127%\begin{definition}
%20181127%\label{def:energy}
%20181127%%---------------------------------------
%20181127%Let $\rvx(t)$ be a random variable.
%20181127%\defboxt{
%20181127%  The \fnctd{energy} of $\rvx(t)$ is
%20181127%  \\\indentx$\ds\pE\brs{\rvx(t)} = \lim_{\tau\to\infty}\frac{1}{2\tau}\int_{-\tau}^{+\tau}\rvx(t)\dt$
%20181127%  }
%20181127%\end{definition}
