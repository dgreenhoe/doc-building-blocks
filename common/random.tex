...
Let $\ps$ be a \structe{probability space}.%
  %\footnote{\hie{probabililty space}: \prefp{def:prob_space}}
\defboxp{
\begin{liste}
   \item the function $\rvx:\pso\to\R$ is a \hid{random variable}
         %\citep{papoulis}{63}
   \item the function $\rvy:\R\times\pso\to\R$ is a \hid{random process}.
         %\citep{papoulis}{285}
\end{liste}
}
\end{definition}
