...
\begin{pspicture}(-0.44,-.40)(0.44,3.50)%
  ...
  %---------------------------------
  \Cnode(0,3){xyz}%
  \Cnode(0,2){xy}%\Cnode(0,2){xz}\Cnode(1,2){yz}%
  \Cnode(0,1){x}%\Cnode(0,1){y}\Cnode(1,1){z}%
  \Cnode(0,0){zero}%
  %---------------------------------
  % node connections
  %---------------------------------
 ...
 %\uput[-90](xz){$xz$-plane}%
  ...
  %    \pspolygon[linecolor=orange](-2,-2)(-2,2)(2,2)(2,-2)%
  %  \end{pspicture}}%
  %\rput(xz){\begin{pspicture}(-2,-2)(2,2)%
  %    \pspolygon[linecolor=dcyan](-1,-3)(-1,1)(1,3)(1,-1)% lower half subspace Y 
  %  \end{pspicture}}%
  \rput(xy){\begin{pspicture}(-2,-2)(2,2)%
      \pspolygon[linecolor=purple](-3,-1)(-1,1)(3,1)(1,-1)% subspace X (xy plane)
    \end{pspicture}}%
