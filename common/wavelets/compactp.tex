...
Let $y\eqd\sin^2\brp{\frac{\omega}{2}}$ and $\fP(y)$ a polynomial in $y$.
\lembox{
  \brb{\begin{array}{FlD}
  ...
  \iff
  \brb{\begin{array}{FlD}
    1. & \text{there exists $\fP(y)$ such that}\\
...
what are the possible solutions of $\fP(y)$?
...
\footnote{
  \citerp{dau}{171},
  \citerppg{pinsky2002}{331}{333}{9780534376604},
  \citerppgc{pinsky2008}{331}{333}{9780534376604}{6.5.2.1 Daubechies recipe},
...
\lemboxt{
  ...
  \left\{\begin{array}{FlD}
    1. & \fP(y) \eqd \ds \fP_p(y) + y^p \fR\brp{\frac{1}{2}-y} & where  \\
       & \fP_p(y) \eqd \ds \sum_{k=0}^{p-1} {p-1+k \choose k} y^k & and \\
    2. & \mcom{\fR(y) = -\fR(-y)}
        ...
        \item We can compute the unique order $p-1$ solution $\fP_p(y)$ of $\fP(y)$ by using
          ...
          \begin{align*}
            \mcom{\fP_p(y)}{order $p-1$}
              ...
              %&& \text{by $(1-y)^p \fP_p(y) + y^p \fP_p(1-y) = 1$}
...
\footnote{
  ...
  \citerpgc{pinsky2008}{333}{9780534376604}{Exercise 6.5.11: $\fP_1(y)$, $\fP_2(y)$, \ldots, $\fP_6(y)$},
...
\begin{array}{r|@{\hs{2ex}}*{20}{r}}
   p & \mc{19}{l}{\fP_p(y)= \sum_{k=0}^{p-1} {p-1+k\choose k} y^k}
\\ \hline
   1 & 1
\\ 2 & 1 &+&  2y
\\ 3 & 1 &+&  3y &+&  6y^2
...
\exbox{\begin{array}{l|l}
   p & \fP_p\left(\frac{z-2+z^{-1}}{-4}\right)
\\ \hline
   1 & 1
\\ 2 & \frac{ z^2 - 4z - 1}{ -2z}
...
is also \prope{minimum phase}\ifsxref{dsp}{def:minphase}.
...
\begin{figure}
  ...
  \exboxt{\begin{tabular}{cc}
    $\begin{array}{|l|r|r|}
      ...
      n & h_n  & g_n
      \\\hline
        0 & \frac{\sqrt{2}}{8}(1+\sqrt{3}) &  \frac{\sqrt{2}}{8}(1-\sqrt{3})
      \\1 & \frac{\sqrt{2}}{8}(3+\sqrt{3}) & -\frac{\sqrt{2}}{8}(3-\sqrt{3})
      \\2 & \frac{\sqrt{2}}{8}(3-\sqrt{3}) &  \frac{\sqrt{2}}{8}(3+\sqrt{3})
      \\3 & \frac{\sqrt{2}}{8}(1-\sqrt{3}) & -\frac{\sqrt{2}}{8}(1+\sqrt{3})
      \\\hline
