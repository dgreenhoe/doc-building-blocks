...
\structe{topological linear space} \ifxref{vstopo}{def:toplinspace}\\
$\spO\eqd\toplinspaceX$.
...
%--------------------------------------
Let $\setxZp{\vx_n}$ be a set of vectors in a \structe{Hilbert space}\ifsxref{seq}{def:hilbert}\\
$\spH\eqd\HspaceX$.
\propbox{
  \brb{\begin{array}{M}
...
% Praise the Lord!!!
%--------------------------------------
Let $\inprodspace{\R^2}{+}{\cdot}{\R}{\dotplus}{\dottimes}{\inprodn}$ be an \structe{inner product space} with
  ...
  \item Proof that $\seqn{\vx_0,\vx_1,\ldots,\vx_{\xN-1}}$ is a \prope{tight frame} with \vale{frame bound} $A=\frac{\xN r^2}{2}$:
        ...
        \begin{align*}
          ...
          \\&= r^2x^2\frac{\xN}{2} + r^2y^2\frac{\xN}{2} + r^2xy0
            && \text{by \thme{Summation around unit circle}\ifsxref{harPoly}{cor:trig_circle}}
       ...
       \item  lemma: $\opS\ve_1=\frac{\xN r^2}{2}\ve_1$. Proof: \label{ilem:frame_R2N_Se1}
         \begin{align*}
           ...
           \\&= r^2\brs{\begin{array}{c} \xN/2\\ 0 \end{array}}
              = \frac{\xN r^2}{2}\ve_1
             \qquad\text{by \thme{Summation around unit circle}\ifsxref{harPoly}{cor:trig_circle}}
           \end{align*}
...
\label{ex:frame_R2pq}
%--------------------------------------
Let $\inprodspace{\R^2}{+}{\cdot}{\R}{\dotplus}{\dottimes}{\inprodn}$\\
be an inner product space where $\inprod{\opair{x_1}{y_1}}{\opair{x_2}{y_2}}\eqd x_1y_1+x_2y_2$.
Let $\opS$ be the \ope{frame operator} \xref{def:frameop} with \ope{inverse} $\opSi$.
\exboxt{%
  $\begin{array}{M}
