...
\begin{pspicture}(-2.5,-1.75)(3.5,1.75)%
  ...
  \rput[bl](-1.45,-1.5){\rnode[b]{circleL}{$\scy\abs{z}=1$}}%
  ...
  \Cnode[linewidth=1pt](-0.0078125,0){zp}%
  %\rput[bl](-1.45,-1.9){\rnode[t]{zpL}{$p$}$=1$ zeroes}%
