...
\begin{pspicture}(-1.5,-1.5)(1.75,1.5)%
  ...
  % zeroes
  %-------------------------------------
  \uput{1}[  36](0,0){\color{red}\pscircle[linecolor=red](0,0){1mm}}%
  \uput{1}[ 108](0,0){\color{red}\pscircle[linecolor=red](0,0){1mm}}%
  \uput{1}[ 180](0,0){\color{red}\pscircle[linecolor=red](0,0){1mm}}%
  \uput{1}[-108](0,0){\color{red}\pscircle[linecolor=red](0,0){1mm}}%
  \uput{1}[ -36](0,0){\color{red}\pscircle[linecolor=red](0,0){1mm}}%
  %-------------------------------------
  % Axis ticks
