...
%20190429%\label{thm:dtft_conjneg}
%20190429%%--------------------------------------
%20190429%Let $\Dx(\omega)\eqd\opDTFT\brs{\seqn{\fx[n]}}(\omega)$ be the \fncte{discrete-time Fourier transform} \xref{def:dtft}
%20190429%of a sequence $\seqxZ{x_n}$ in $\spllR$.
%20190429%\thmbox{
%20190429%  \brb{\begin{array}{>{\ds}rc>{\ds}l}
%20190429%    \Fx(\omega) &\eqd& \opDTFT\seqn{\fx[n]}
%20190429%    %\\\mc{3}{F}{(\ope{DTFT})}
%20190429%    %\\\mc{3}{M}{\xref{def:dtft}}
%20190429%  \end{array}}
%20190429%  \quad\implies\quad
%20190429%  \brb{\begin{array}{F>{\ds}rc>{\ds}lD}
%20190429%      (1).&\opDTFT\seqn{\fx      [-n]} &=& \Fx      (-\omega) & and
%20190429%    \\(2).&\opDTFT\seqn{\fx^\conj[ n]} &=& \Fx^\conj(-\omega) & and
%20190429%    \\(3).&\opDTFT\seqn{\fx^\conj[-n]} &=& \Fx^\conj( \omega) & 
%20190429%  \end{array}}
%20190429%  }
%20190429%\end{theorem}
%20190429%\begin{proof}
%20190429%\begin{align*}
%20190429%  \opDTFT\seqn{\fx[-n]}
%20190429%    &\eqd \sum_{n\in\Z} \fx[-n] e^{-i\omega n}
%20190429%    && \text{by definition of \ope{DTFT}}
%20190429%    && \text{\xref{def:dtft}}
%20190429%  \\&= \sum_{m\in\Z} \fx[m] e^{i\omega m}
%20190429%     && \text{where $m\eqd-n$ $\implies$ $n=-m$}
%20190429%  \\&= \sum_{m\in\Z} \fx[m] e^{-i(-\omega)m}
%20190429%  \\&\eqd \Fx(-\omega)
%20190429%    && \text{by left hypothesis}
%20190429%    \\
%20190429%    \\
%20190429%  \opDTFT\seqn{\fx^\conj[n]}
%20190429%    &\eqd \sum_{n\in\Z} \fx^\conj[n] e^{-i\omega n}
%20190429%    && \text{by definition of \ope{DTFT}}
%20190429%    && \text{\xref{def:dtft}}
%20190429%  \\&= \brp{\sum_{n\in\Z} \fx[n] e^{i\omega n}}^\conj
%20190429%     && \text{by \prope{distributive} property of \structd{$\invo$-algebra}s}
%20190429%     && \text{\xref{def:staralg}}
%20190429%  \\&= \brp{\sum_{n\in\Z} \fx[n] e^{-i(-\omega)n}}^\conj
%20190429%  \\&\eqd \Fx^\conj(-\omega)
%20190429%    && \text{by left hypothesis}
%20190429%    \\
%20190429%    \\
%20190429%  \opDTFT\seqn{\fx^\conj[-n]}
...
%20190429%     && \text{by \prope{distributive} property of \structd{$\invo$-algebra}s}
%20190429%     && \text{\xref{def:staralg}}
%20190429%  \\&= \brp{\sum_{m\in\Z} \fx[m] e^{-i\omega m}}^\conj
%20190429%     && \text{where $m\eqd-n$ $\implies$ $n=-m$}
%20190429%  \\&\eqd \Fx^\conj(\omega)
%20190429%    && \text{by left hypothesis}
%20190429%\end{align*}
...
%20190429%%--------------------------------------
%20190429%\begin{theorem}
%20190429%\label{thm:dtft_conjneg_real}
%20190429%%--------------------------------------
%20190429%Let $\Dx(\omega)\eqd\opDTFT\brs{\seqn{\fx[n]}}(\omega)$ be the \fncte{discrete-time Fourier transform} \xref{def:dtft}
%20190429%of a sequence $\seqxZ{\fx[n]}$ in $\spllR$.
%20190429%\thmbox{
%20190429%  \brb{\begin{array}{FMD}
%20190429%      (1).&$\Fx(\omega) \eqd \opDTFT\seqn{\fx[n]}$ & and
%20190429%    \\(2).&$\seqn{\fx[n]}$ is \prope{real-valued}
%20190429%  \end{array}}
%20190429%  \quad\implies\quad
%20190429%  \brb{\begin{array}{F>{\ds}rc>{\ds}lc>{\ds}lD}
%20190429%      (1).&\opDTFT\seqn{\fx      [-n]} &=& \Fx      (-\omega) & &              & and
%20190429%    \\(2).&\opDTFT\seqn{\fx^\conj[ n]} &=& \Fx^\conj(-\omega) &=& \Fx( \omega) & and
%20190429%    \\(3).&\opDTFT\seqn{\fx^\conj[-n]} &=& \Fx^\conj( \omega) &=& \Fx(-\omega) & 
%20190429%  \end{array}}
%20190429%  }
%20190429%\end{theorem}
%20190429%\begin{proof}
...
%20190429%    \\
%20190429%    \\
%20190429%  \boxed{\Fx^\conj(-\omega)}
%20190429%    &= \boxed{\opDTFT\seqn{\fx^\conj[n]}}
%20190429%    && \text{by \prefp{thm:dtft_conjneg}}
%20190429%  \\&= \opDTFT\seqn{\fx[n]}
%20190429%    && \text{by \prope{real-valued} hypothesis}
%20190429%  \\&= \boxed{\Fx(\omega)}
%20190429%    && \text{by definition of $\Fx(\omega)$}
%20190429%    && \text{\xref{def:dtft}}
%20190429%    \\
%20190429%    \\
%20190429%  \boxed{\Fx^\conj( \omega)}
