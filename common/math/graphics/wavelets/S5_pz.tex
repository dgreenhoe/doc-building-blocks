...
\begin{pspicture}(-1.5,-2)(4.1,2)%
  ...
  \rput[bl](-1.45,-1.9){\rnode[t]{zpL}{$p$}$=5$ zeroes}%
  \ncline[linestyle=dotted,linecolor=zero,nodesepA=1pt]{->}{zpL}{zp}%
  \uput{1mm}[30](-1,0){\color{zero}$\scy5$}%
  %-------------------------------------
  % orthogonality zeroes
  %-------------------------------------
  \Cnode [linecolor=zero,linewidth=1pt](  0.337189581075, -0.091340568811 ){z1}%
  \Cnode [linecolor=zero,linewidth=1pt](  0.337189581075,  0.091340568811 ){z2}%
  \Cnode [linecolor=zero,linewidth=1pt](  1.622814496164, -1.795531871418 ){z3}%
  \Cnode [linecolor=zero,linewidth=1pt](  1.622814496164,  1.795531871418 ){z4}%
  \Cnode*[linecolor=zero,linewidth=1pt](  2.762945109681, -0.748448327222 ){z5}%
  \Cnode*[linecolor=zero,linewidth=1pt](  2.762945109681,  0.748448327222 ){z6}%
  \Cnode*[linecolor=zero,linewidth=1pt](  0.277050813081, -0.306537540837 ){z7}%
  \Cnode*[linecolor=zero,linewidth=1pt](  0.277050813081,  0.306537540837 ){z8}%
  %-------------------------------------
  % radial lines
  %-------------------------------------
  ...
  \rput[tl](-1.45,1.9){$2$\rnode[br]{polesL}{$p$}$-1=9$ poles}%
  \ncline[linestyle=dotted,linecolor=pole,nodesepA=0pt,nodesepB=5pt]{->}{polesL}{poles}%
  \uput{1mm}[30](0,0){\color{pole}$\scy9$}%
  %%-------------------------------------
...
%  %---------------------------
%  \color{pole}%
%  \put(-100,-100){\makebox(0,0)[tr]{9 poles}}             % 2p-1 poles
%  \put(-100,-100){\vector(1,1){91}}
%  \put(   0,    0){\makebox(0,0)[c]{$\times$}}
%  \put(   0,    0){\makebox(0,0)[c]{\hspace{1em}$^{9}$}}
%
%  %Zeros
%  %---------------------------
%  \color{zero}%
%  \put(-150, -50){\makebox(0,0)[tr]{p=5 zeros}}           % p zeros
%  \put(-150, -50){\vector( 1, 1){43}}
%  \put(-100,    0){\circle{15}$^{5}$}
%
%  \put(   33.7189581075,   -9.1340568811 ) {\circle {15}} 
%  \put(   33.7189581075,    9.1340568811 ) {\circle {15}} 
%  \put(  162.2814496164, -179.5531871418 ) {\circle {15}} 
%  \put(  162.2814496164,  179.5531871418 ) {\circle {15}} 
%  \put(  276.2945109681,  -74.8448327222 ) {\circle*{15}} 
%  \put(  276.2945109681,   74.8448327222 ) {\circle*{15}} 
%  \put(   27.7050813081,  -30.6537540837 ) {\circle*{15}} 
%  \put(   27.7050813081,   30.6537540837 ) {\circle*{15}} 
%\end{picture}
