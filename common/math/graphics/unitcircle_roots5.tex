...
\begin{pspicture}(-1.5,-1.5)(1.75,1.5)%
  ...
  \uput{1.0}[  36](origin){\pnode(0,0){root1}}%
  \uput{1.0}[ 108](origin){\pnode(0,0){root2}}%
  \uput{1.0}[ 180](origin){\pnode(0,0){root3}}%
  \uput{1.0}[-108](origin){\pnode(0,0){root4}}%
  \uput{1.0}[ -36](origin){\pnode(0,0){root5}}%
  %-------------------------------------
  % axes
  %-------------------------------------
